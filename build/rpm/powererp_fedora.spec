...
echo Run post script of packager powererp_fedora.spec
...
semanage fcontext -a -t httpd_sys_script_rw_t "/etc/powererp(/.*?)"
semanage fcontext -a -t httpd_sys_script_rw_t "/var/lib/powererp(/.*?)"
