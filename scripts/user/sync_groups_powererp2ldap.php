...
/**
 * \file scripts/user/sync_groups_powererp2ldap.php
 * \ingroup ldap core
 * \brief Script de mise a jour des groupes dans LDAP depuis base PowerERP
 */
 ...
 * {
 * print $langs->trans("LDAPSynchronizationNotSetupInPowerERP");
 * exit(-1);
 * }
 */
