 ...
 */
class Interventions extends PowerERPApi
{
	...
	{
		if (!PowerERPApiAccess::$user->rights->ficheinter->lire) {
		...
		if (!PowerERPApi::_checkAccessToResource('fichinter', $this->fichinter->id)) {
	...
	public function post($request_data = null)
	{
		...
		if ($this->fichinter->create(PowerERPApiAccess::$user) < 0) {
	...
	*/
	...
	public function delete($id)
	{
		...
		if (!$this->fichinter->delete(PowerERPApiAccess::$user)) {
	...
	public function validate($id, $notrigger = 0)
	{
		...
		$result = $this->fichinter->setValid(PowerERPApiAccess::$user, $notrigger);
		if ($result == 0) {
