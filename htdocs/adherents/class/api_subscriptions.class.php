 ...
 */
class Subscriptions extends PowerERPApi
{
	/**
	...
	public function post($request_data = null)
	{
		...
		if ($subscription->create(PowerERPApiAccess::$user) < 0) {
	...
	public function put($id, $request_data = null)
	{
		...
		if ($subscription->update(PowerERPApiAccess::$user) > 0) {
			return $this->get($id);
		} else {
	...
	public function delete($id)
	{
		...
		$res = $subscription->delete(PowerERPApiAccess::$user);
		if ($res < 0) {
