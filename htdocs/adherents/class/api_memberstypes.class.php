 ...
 */
class MembersTypes extends PowerERPApi
{
	/**
	...
	public function get($id)
	{
		...
		if (!PowerERPApi::_checkAccessToResource('member', $membertype->id, 'adherent_type')) {
	...
	{
		if (!PowerERPApiAccess::$user->rights->adherent->configurer) {
			throw new RestException(401);
		}
		...
		if ($membertype->create(PowerERPApiAccess::$user) < 0) {
	...
	public function put($id, $request_data = null)
	{
		...
		if ($membertype->update(PowerERPApiAccess::$user) >= 0) {
			return $this->get($id);
		} else {
