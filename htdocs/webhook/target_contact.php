...
if ($enablepermissioncheck) {
	...
	$permission = $user->rights->webhook->target->write;
} else {
	$permissiontoread = 1;
	$permission = 1;
}
...
$title = $langs->trans('Target')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Target"), -1, $object->picto);
