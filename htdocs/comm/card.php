...
if ($object->id > 0) {
	...
	*/
	...
	if (isModEnabled('adherent')) {
		...
		print '<tr><td class="titlefield">'.$langs->trans("LinkedToPowerERPMember").'</td>';
		print '<td>';
		$adh = new Adherent($db);
	...
	$boxstat .= '<table summary="'.dol_escape_htmltag($langs->trans("PowerERPStateBoard")).'" class="border boxtable boxtablenobottom boxtablenotop boxtablenomarginbottom centpercent">';
