...
if ($action == "valid" || $action == "history" || $action == 'creditnote') {
	...
	if (getDolGlobalString('TAKEPOS_PRINT_METHOD') == "takeposconnector") {
		...
		$sectionwithinvoicelink .= ' <button id="buttonprint" type="button" onclick="PowererpTakeposPrinting('.$placeid.');">'.$langs->trans('PrintTicket').'</button>';
	} else {
...
function PowererpTakeposPrinting(id) {
	console.log("PowererpTakeposPrinting Printing invoice ticket " + id)
	$.ajax({
		type: "GET",
