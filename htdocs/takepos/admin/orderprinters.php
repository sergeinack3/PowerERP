...
if ($action == "SavePrinter1") {
	...
	powererp_set_const($db, "TAKEPOS_PRINTED_CATEGORIES_1", $printedcategories, 'chaine', 0, '', $conf->entity);
}
...
if ($action == "SavePrinter2") {
	...
	powererp_set_const($db, "TAKEPOS_PRINTED_CATEGORIES_2", $printedcategories, 'chaine', 0, '', $conf->entity);
}
...
if ($action == "SavePrinter3") {
	...
	powererp_set_const($db, "TAKEPOS_PRINTED_CATEGORIES_3", $printedcategories, 'chaine', 0, '', $conf->entity);
}
