...
$fullurl = '<a href="'.$urlpowererp.'" target="_blank" rel="noopener noreferrer">'.$urlpowererp.'</a>';
print str_replace('{s}', $fullurl, $langs->trans("DownloadPackageFromWebSite", '{s}')).'<br>';
print '<b>'.$langs->trans("StepNb", 2).'</b>: ';
print str_replace('{s}', $powererproot, $langs->trans("UnpackPackageInPowerERPRoot", '{s}')).'<br>';
print '<b>'.$langs->trans("StepNb", 3).'</b>: ';
print $langs->trans("RemoveLock", $powererpdataroot.'/install.lock').'<br>';
...
print $langs->trans("RestoreLock", $powererpdataroot.'/install.lock').'<br>';
