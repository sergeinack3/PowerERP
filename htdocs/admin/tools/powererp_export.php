...
/**
 *		\file 		htdocs/admin/tools/powererp_export.php
 *		\ingroup	core
...
print $langs->trans("BackupDesc3", $powererp_main_db_name).'<br>';
...
print $langs->trans("DatabaseName").' : <b>'.$powererp_main_db_name.'</b><br>';
print '</td>';
print '</tr>';
...
if (!empty($_SESSION["commandbackuptorun"])) {
	print '<br><span class="warning">'.$langs->trans("YouMustRunCommandFromCommandLineAfterLoginToUser", $powererp_main_db_user, $powererp_main_db_user).':</span><br>'."\n";
...
$prefix = 'documents';
$ext = 'zip';
$file = $prefix.'_'.$powererp_main_db_name.'_'.dol_sanitizeFileName(DOL_VERSION).'_'.dol_print_date(dol_now('gmt'), "dayhourlogsmall", 'tzuser');
