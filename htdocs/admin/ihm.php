...
if ($action == 'update') {
	...
	if ($mode == 'template') {
		...
		if (! $val) powererp_del_const($db, 'THEME_TOPMENU_DISABLE_IMAGE', $conf->entity);
		else powererp_set_const($db, 'THEME_TOPMENU_DISABLE_IMAGE', GETPOST('THEME_TOPMENU_DISABLE_IMAGE'), 'chaine', 0, '', $conf->entity);*/
