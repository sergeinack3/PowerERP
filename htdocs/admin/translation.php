...
if ($action == 'setMAIN_ENABLE_OVERWRITE_TRANSLATION') {
	if (GETPOST('value')) {
		powererp_set_const($db, 'MAIN_ENABLE_OVERWRITE_TRANSLATION', 1, 'chaine', 0, '', $conf->entity);
	} else {
		powererp_set_const($db, 'MAIN_ENABLE_OVERWRITE_TRANSLATION', 0, 'chaine', 0, '', $conf->entity);
	}
}
