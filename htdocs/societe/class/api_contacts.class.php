 ...
 */
class Contacts extends PowerERPApi
{
	/**
	 *
	...
	{
		if (!PowerERPApiAccess::$user->rights->societe->contact->lire) {
		...
		if (!PowerERPApi::_checkAccessToResource('contact', $this->contact->id, 'socpeople&societe')) {
	...
	public function post($request_data = null)
	{
		...
		if ($this->contact->create(PowerERPApiAccess::$user) < 0) {
	...
	public function put($id, $request_data = null)
	{
		...
		if ($this->contact->update($id, PowerERPApiAccess::$user, 1, 'update')) {
			return $this->get($id);
		}
	...
	{
		if (!PowerERPApiAccess::$user->rights->societe->contact->supprimer) {
	...
	{
		//if (!PowerERPApiAccess::$user->rights->user->user->creer) {
		...
		if (!PowerERPApi::_checkAccessToResource('contact', $contact->id, 'socpeople&societe')) {
			throw new RestException(401, 'Access not allowed for login '.PowerERPApiAccess::$user->login);
		}
	...
	public function addCategory($id, $category_id)
	{
		...
		if (!PowerERPApi::_checkAccessToResource('contact', $this->contact->id)) {
			throw new RestException(401, 'Access not allowed for login '.PowerERPApiAccess::$user->login);
		}
