...
if ($projectid > 0) {
	...
	//print '</span>';
	print '</td><td class="valuefield">';
	$linksuggest = $powererp_main_url_root.'/public/project/index.php?id='.((int) $project->id);
	...
	//print '</span>';
	print '</td><td class="valuefield">';
	$link_subscription = $powererp_main_url_root.'/public/eventorganization/attendee_new.php?id='.((int) $project->id).'&type=global';
	$encodedsecurekey = dol_hash(getDolGlobalString('EVENTORGANIZATION_SECUREKEY').'conferenceorbooth'.((int) $project->id), 'md5');
