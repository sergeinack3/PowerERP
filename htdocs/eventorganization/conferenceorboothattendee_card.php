...
if (!empty($withproject)) {
	...
	//print '</span>';
	print '</td><td>';
	$linksuggest = $powererp_main_url_root.'/public/project/index.php?id='.$projectstatic->id;
	...
	//print '</span>';
	print '</td><td>';
	$link_subscription = $powererp_main_url_root.'/public/eventorganization/attendee_new.php?id='.$projectstatic->id.'&type=global';
	$encodedsecurekey = dol_hash($conf->global->EVENTORGANIZATION_SECUREKEY.'conferenceorbooth'.$projectstatic->id, 'md5');
