...
/**
 *  \file       entrepot_agenda.php
 *  \ingroup    localisation
 *  \brief      Tab of events on Entrepot
 */
...
$hookmanager->initHooks(array('entrepotagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Entrepot"), -1, $object->picto);
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnEntrepot"), '', '');
