...
/**
 *  \file       mouvement_pour_localisation_note.php
 *  \ingroup    mouvement
 *  \brief      Tab for notes on Mouvement_pour_localisation
 */
...
$hookmanager->initHooks(array('mouvement_pour_localisationnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Mouvement_pour_localisation'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Mouvement_pour_localisation"), -1, $object->picto);
