...
/**
 *  \file       mouvement_pour_localisation_agenda.php
 *  \ingroup    mouvement
 *  \brief      Tab of events on Mouvement_pour_localisation
 */
...
$hookmanager->initHooks(array('mouvement_pour_localisationagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Mouvement_pour_localisation"), -1, $object->picto);
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnMouvement_pour_localisation"), '', '');
