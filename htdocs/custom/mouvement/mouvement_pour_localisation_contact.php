...
/**
 *  \file       mouvement_pour_localisation_contact.php
 *  \ingroup    mouvement
 *  \brief      Tab for contacts linked to Mouvement_pour_localisation
 */
...
$hookmanager->initHooks(array('mouvement_pour_localisationcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permission = $user->rights->mouvement->mouvement_pour_localisation->write;
} else {
	$permissiontoread = 1;
	$permission = 1;
}
...
$title = $langs->trans('Mouvement_pour_localisation')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Mouvement_pour_localisation"), -1, $object->picto);
