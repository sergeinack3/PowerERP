...
print '<div class="appro_container">';
print '<div class="appro_item">';
// print '<h3>Chef de Piste</h3>';
print '<tr><td class="titlefield">Chef de piste</td>';
print '<td>';
print $form->select_dolusers('', 'user');
print $form->select_dolusers("", 'user', 1, '', 0, '', 0, '', 0, 0, '', 0, '', 'widthcentpercentminusx maxwidth300');
if ($caneditfield) {
