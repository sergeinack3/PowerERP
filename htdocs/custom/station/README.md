# STATION FOR [DOLIBARR ERP CRM](https://www.powererp.org)
...
<!--
![Screenshot station](img/screenshot_station.png?raw=true "Station"){imgmd}
-->
...
- Clone the repository in ```$powererp_main_document_root_alt/station```

```sh
cd ....../custom
git clone git@github.com:gitlogin/station.git station
```
