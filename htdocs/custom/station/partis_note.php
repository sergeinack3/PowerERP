...
/**
 *  \file       partis_note.php
 *  \ingroup    station
 *  \brief      Tab for notes on Partis
 */
...
$hookmanager->initHooks(array('partisnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Partis'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Partis"), -1, $object->picto);
