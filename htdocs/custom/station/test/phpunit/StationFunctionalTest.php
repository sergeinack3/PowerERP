...
/**
 * \file    test/phpunit/StationFunctionalTest.php
 * \ingroup station
 ...
 * @package Teststation
 */
class StationFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/station/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('station/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/station/admin/about.php');
		$this->authenticate();
		return $this->assertContains('station/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('stationwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modStation_StationTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modStation_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
