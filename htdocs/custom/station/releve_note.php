...
/**
 *  \file       releve_note.php
 *  \ingroup    station
 *  \brief      Tab for notes on Releve
 */
...
$hookmanager->initHooks(array('relevenote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Releve'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Releve"), -1, $object->picto);
