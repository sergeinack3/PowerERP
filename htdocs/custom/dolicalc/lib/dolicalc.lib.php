...
function DoliCalcAdminPrepareHead()
{
    global $langs, $conf;
    ...
    $head[$h][0] = dol_buildpath("/dolicalc/admin/setup.php", 1);
    $head[$h][1] = $langs->trans("Settings");
    $head[$h][2] = 'settings';
    $h++;
    $head[$h][0] = dol_buildpath("/dolicalc/admin/about.php", 1);
    ...
    //	'entity:-tabname:Title:@listexportimport:/listexportimport/mypage.php?id=__ID__'
    //); // to remove a tab
    complete_head_from_modules($conf, $langs, $object, $head, $h, 'dolicalc');
