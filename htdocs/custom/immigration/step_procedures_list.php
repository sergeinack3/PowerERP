...
/**
 *   	\file       step_procedures_list.php
 *		\ingroup    immigration
 *		\brief      List page for step_procedures
 */
...
$hookmanager->initHooks(array('step_procedureslist')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->rights->immigration->step_procedures->write;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Step_procedures';
	$objectlabel = 'Step_procedures';
...
//$help_url = "EN:Module_Step_procedures|FR:Module_Step_procedures_FR|ES:Módulo_Step_procedures";
$help_url = '';
$title = $langs->trans("Step_procedures").'s';
$morejs = array();
$morecss = array();
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/immigration/step_procedures_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/immigration/step_procedures_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendStep_proceduresRef";
$modelmail = "step_procedures";
$objecttmp = new Step_procedures($db);
