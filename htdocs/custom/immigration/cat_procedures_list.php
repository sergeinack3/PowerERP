...
/**
 *   	\file       cat_procedures_list.php
 *		\ingroup    immigration
 *		\brief      List page for cat_procedures
 */
...
$hookmanager->initHooks(array('cat_procedureslist')); // Note that conf->hooks_modules contains array
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Cat_procedures';
	$objectlabel = 'Cat_procedures';
...
//$help_url = "EN:Module_Cat_procedures|FR:Module_Cat_procedures_FR|ES:Módulo_Cat_procedures";
$help_url = '';
$title = $langs->trans("Cat_procedures").'s';
$morejs = array();
$morecss = array();
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/immigration/cat_procedures_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/immigration/cat_procedures_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendCat_proceduresRef";
$modelmail = "cat_procedures";
$objecttmp = new Cat_procedures($db);
