...
class modImmigration extends PowerERPModules
{
	...
	public function __construct($db)
	{
		...
		*/
		...
		$this->cronjobs = array(
			...
			//      'label' => 'MyJob label',
			//      'jobtype' => 'method',
			//      'class' => '/immigration/class/myobject.class.php',
			//      'objectname' => 'MyObject',
		...
		$this->rights[$r][1] = 'Read objects of Immigration'; // Permission label
		$this->rights[$r][4] = 'myobject';
		$this->rights[$r][5] = 'read'; // In php code, permission will be checked by test if ($user->rights->immigration->myobject->read)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Create/Update objects of Immigration'; // Permission label
		$this->rights[$r][4] = 'myobject';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->immigration->myobject->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Delete objects of Immigration'; // Permission label
		$this->rights[$r][4] = 'myobject';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->immigration->myobject->delete)
		$r++;
		...
		$this->menu[$r++] = array(
			...
			'perms'=>'1', // Use 'perms'=>'$user->rights->immigration->myobject->read' if you want your menu with a permission rules
			'target'=>'',
		...
		$this->menu[$r++]=array(
			...
			'position'=>1000+$r,
			'enabled'=>'$conf->immigration->enabled',  // Define condition to show or hide menu entry. Use '$conf->immigration->enabled' if entry must be visible if module is enabled.
			'perms'=>'$user->rights->immigration->myobject->read',			                // Use 'perms'=>'$user->rights->immigration->level1->level2' if you want your menu with a permission rules
			'target'=>'',
			'user'=>2,				                // 0=Menu for internal users, 1=external users, 2=both
		);
		$this->menu[$r++]=array(
			'fk_menu'=>'fk_mainmenu=immigration,fk_leftmenu=myobject',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>'List_MyObject',
			'mainmenu'=>'immigration',
			'leftmenu'=>'immigration_myobject_list',
			'url'=>'/immigration/myobject_list.php',
			'langs'=>'immigration@immigration',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000+$r,
		...
		$this->menu[$r++]=array(
			...
			'titre'=>'New_MyObject',
			'mainmenu'=>'immigration',
			'leftmenu'=>'immigration_myobject_new',
			'url'=>'/immigration/myobject_card.php?action=create',
			'langs'=>'immigration@immigration',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>1000+$r,
			'enabled'=>'$conf->immigration->enabled',  // Define condition to show or hide menu entry. Use '$conf->immigration->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'perms'=>'$user->rights->immigration->myobject->write',			                // Use 'perms'=>'$user->rights->immigration->level1->level2' if you want your menu with a permission rules
			'target'=>'',
			'user'=>2,				                // 0=Menu for internal users, 1=external users, 2=both
		);
		...
		$this->export_icon[$r]='myobject@immigration';
		// Define $this->export_fields_array, $this->export_TypeFields_array and $this->export_entities_array
		$keyforclass = 'MyObject'; $keyforclassfile='/immigration/class/myobject.class.php'; $keyforelement='myobject@immigration';
		include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		//$this->export_fields_array[$r]['t.fieldtoadd']='FieldToAdd'; $this->export_TypeFields_array[$r]['t.fieldtoadd']='Text';
		//unset($this->export_fields_array[$r]['t.fieldtoremove']);
		//$keyforclass = 'MyObjectLine'; $keyforclassfile='/immigration/class/myobject.class.php'; $keyforelement='myobjectline@immigration'; $keyforalias='tl';
		//include DOL_DOCUMENT_ROOT.'/core/commonfieldsinexport.inc.php';
		$keyforselect='myobject'; $keyforaliasextra='extra'; $keyforelement='myobject@immigration';
		include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
		//$keyforselect='myobjectline'; $keyforaliasextra='extraline'; $keyforelement='myobjectline@immigration';
		//include DOL_DOCUMENT_ROOT.'/core/extrafieldsinexport.inc.php';
	...
	public function init($options = '')
	{
		...
		//$result = $this->_load_tables('/install/mysql/tables/', 'immigration');
