...
/**
 *  \file       cat_procedures_agenda.php
 *  \ingroup    immigration
 *  \brief      Tab of events on Cat_procedures
 */
...
$hookmanager->initHooks(array('cat_proceduresagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Cat_procedures"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnCat_procedures"), '', '');
