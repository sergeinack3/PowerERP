...
dol_include_once('/immigration/css/style.class.php');



// Load translation files required by the page
$langs->loadLangs(array("immigration@immigration"));
...
// Draft MyObject
if (! empty($conf->immigration->enabled) && $user->rights->immigration->read)
{
	$langs->load("orders");
...
if (! empty($conf->immigration->enabled) && $user->rights->immigration->read)
{
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."immigration_myobject as s";
	//if (! $user->rights->societe->client->voir && ! $socid) $sql.= ", ".MAIN_DB_PREFIX."societe_commerciaux as sc";
