...
/**
 *  \file       procedures_note.php
 *  \ingroup    immigration
 *  \brief      Tab for notes on Procedures
 */
...
$hookmanager->initHooks(array('proceduresnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
$title = $langs->trans('Procedures').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Procedures"), -1, $object->picto);
