...
class ecvcertificats extends Commonobject{ 

	public $errors = array();
	public $rowid;
	public $ref;

	public $element='ecvcertificats';
	public $table_element='ecvcertificats';
	...
	public function select_niveau($niveau=''){
	   
	    $moreforfilter.='<select class="flat" id="niveau" name="niveau" >';
		...
		$moreforfilter.='<option value="Doctorat" >Doctorat </option>';
	    $moreforfilter.='</select>';
