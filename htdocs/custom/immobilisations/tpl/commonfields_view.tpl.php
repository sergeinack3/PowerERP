...
foreach ($object->fields as $key => $val) {
	...
	if (in_array($key, array('ref', 'status', 'description'))) {
		...
		if (isset($val['copytoclipboard']) && $val['copytoclipboard'] == 2) {
			...
			switch ($key) {
				case 'fk_product':
					...
					print '<a href="" class="classfortooltip"><span class="fas fa-cube" style=" color: #a69944; margin-right : 5px;"></span>'.$value.'</a>'; //'.$_SERVER['PHP_SELF'].'?id='.$value.'" title="&lt;img src=&quot;'.$conf->file->dol_url_root['main'].'/immobilisations/img/categories.png&quot; alt=&quot;&quot; class=&quot;inline-block&quot;&gt; &lt;u&gt;Familles&lt;/u&gt;&lt;br&gt;&lt;b&gt;R&eacute;f.:&lt;/b&gt; '.$value.'
					
					break;
				case 'fk_categorie':

					print '<a href="'.$_SERVER['PHP_SELF'].'?id='.$value.'" title="&lt;img src=&quot;'.$conf->file->dol_url_root['main'].'/immobilisations/img/categories.png&quot; alt=&quot;&quot; class=&quot;inline-block&quot;&gt; &lt;u&gt;Familles&lt;/u&gt;&lt;br&gt;&lt;b&gt;R&eacute;f.:&lt;/b&gt; '.$value.'" class="classfortooltip"><img src="'.$conf->file->dol_url_root['main'].$conf->file->dol_url_root['alt0'].'/immobilisations/img/object_categories.png" class="paddingright classfortooltip">'.$object->fetchLabelCategorie($value).'</a>';
					break;
