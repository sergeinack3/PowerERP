		...
		if (isset($val['copytoclipboard']) && $val['copytoclipboard'] == 2) {
			...
			switch ($key) {
				case 'fk_product':
					...
					print '<span class="fas fa-cube" style=" color: #a69944; margin-right : 5px;"></span>' . $value;
					break;
				...
				case 'fk_categorie':
					print '<a href="categories_card.php?id=' . $value . '" class="classfortooltip"><img src="' . $conf->file->dol_url_root['main'] . $conf->file->dol_url_root['alt0'] . '/immobilisations/img/object_categories.png" class="paddingright classfortooltip">' . $object->fetchLabelCategorie($value) . '</a>';
					break;

				case 'fk_parent':
					if (!empty($value)) {
						print '<a href="categories_card.php?id=' . $value . '" class="classfortooltip"><img src="' . $conf->file->dol_url_root['main'] . $conf->file->dol_url_root['alt0'] . '/immobilisations/img/object_categories.png" class="paddingright classfortooltip">' . $object->getRefCategory($value) . '</a>';
					} else {
						print '';
					}
					break;
