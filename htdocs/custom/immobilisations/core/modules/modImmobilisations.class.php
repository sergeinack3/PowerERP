...
class modImmobilisations extends powererpModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 432451; // TODO Go on page https://wiki.powererp.org/index.php/List_of_modules_id to reserve an id number for your module
		...
		$this->picto = 'immobilisations@immobilisations';
		...
		*/
		...
		$this->rights[$r][1] = $langs->trans('rigth1'); // Permission label
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = $langs->trans('rigth2'); // Permission label
		$this->rights[$r][4] = 'immobilisations';
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = $langs->trans('rigth3'); // Permission label
		$this->rights[$r][4] = 'immobilisations';
		...
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = $langs->trans('rigth4'); // Permission label
		$this->rights[$r][4] = 'immobilisations';
		$this->rights[$r][5] = 'statistic'; // In php code, permission will be checked by test if ($user->rights->immobilisations->immobilisations->delete)
		$r++;

		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = $langs->trans('rigth5'); // Permission label
		$this->rights[$r][4] = 'immobilisations';
		$this->rights[$r][5] = 'configuration'; // In php code, permission will be checked by test if ($user->rights->immobilisations->immobilisations->delete)
		$r++;
		...
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = $langs->trans('rigth6'); // Permission label
		$this->rights[$r][4] = 'immobilisations';
		...
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = $langs->trans('rigth7'); // Permission label
		$this->rights[$r][4] = 'immobilisations';
		...
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = $langs->trans('rigth8'); // Permission label
		$this->rights[$r][4] = 'immobilisations';
		...
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = $langs->trans('rigth9'); // Permission label
		$this->rights[$r][4] = 'immobilisations';
		...
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = $langs->trans('rigth10'); // Permission label
		$this->rights[$r][4] = 'immobilisations';
		...
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = $langs->trans('rigth11'); // Permission label
		...
		$this->menu[$r++] = array(
			...
			'position' => $const + $r,
			'enabled' => '$conf->immobilisations->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilisations->enabled' if entry must be visible if module is enabled.
			'perms' => '$user->rights->immobilisations->immobilisations->configuration',			                // Use 'perms'=>'$user->rights->immobilisations->level1->level2' if you want your menu with a permission rules
			'target' => '',
			'user' => 2,				                // 0=Menu for internal users, 1=external users, 2=both
		);
		...
		$this->menu[$r++] = array(
			...
			'type' => 'left',                          // This is a Left menu entry
			'titre' => 'Statistiques',
			'prefix' => img_picto('', 'object_statistique.png@immobilisations', 'class="paddingright pictofixedwidth valignmiddle"'),
			'mainmenu' => 'immobilisations',
			...
			'position' => $const + $r,
			'enabled' => '$conf->immobilisations->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilisations->enabled' if entry must be visible if module is enabled.
			'perms' => '$user->rights->immobilisations->immobilisations->statistic',			                // Use 'perms'=>'$user->rights->immobilisations->level1->level2' if you want your menu with a permission rules
			'target' => '',
			'user' => 2,				                // 0=Menu for internal users, 1=external users, 2=both
		);
		...
		$this->menu[$r++] = array(
			...
			'perms' => '$user->rights->immobilisations->immobilisations->read',
			'target' => '',
		...
		$this->menu[$r++] = array(
			...
			'enabled' => '$conf->immobilisations->enabled',
			// Use 'perms'=>'$user->rights->immobilisations->level1->level2' if you want your menu with a permission rules
			'perms' => '$user->rights->immobilisations->immobilisations->write',
			'target' => '',
			// 0=Menu for internal users, 1=external users, 2=both
			'user' => 2
		);
		...
		$this->menu[$r++] = array(
			...
			'enabled' => '$conf->immobilisations->enabled',
			// Use 'perms'=>'$user->rights->immobilisations->level1->level2' if you want your menu with a permission rules
			'perms' => '$user->rights->immobilisations->categories->read',
			'target' => '',
			// 0=Menu for internal users, 1=external users, 2=both
			'user' => 2
		);
		...
		$this->menu[$r++] = array(
			...
			'enabled' => '$conf->immobilisations->enabled',
			// Use 'perms'=>'$user->rights->immobilisations->level1->level2' if you want your menu with a permission rules
			'perms' => '$user->rights->immobilisations->categories->write',
			'target' => '',
			// 0=Menu for internal users, 1=external users, 2=both
			'user' => 2
		);
