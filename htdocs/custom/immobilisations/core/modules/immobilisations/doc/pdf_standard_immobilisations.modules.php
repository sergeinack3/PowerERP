...
/**
 *  \file       core/modules/immobilisations/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_immobilisations
 */
class pdf_standard_immobilisations extends ModelePDFImmobilisations
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_IMMOBILISATIONS_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->immobilisations->dir_output.'/immobilisations') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->immobilisations->dir_output.'/immobilisations';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->immobilisations->dir_output.'/immobilisations/'.$objectref;
