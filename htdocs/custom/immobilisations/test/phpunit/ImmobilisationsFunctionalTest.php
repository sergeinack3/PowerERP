...
/**
 * \file    test/phpunit/ImmobilisationsFunctionalTest.php
...
/**
 * Class ImmobilisationsFunctionalTest
 *
 ...
 *
 * @package Testimmobilisations
 */
class ImmobilisationsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modImmobilisations')->click();
		} else {
			// Disable the module
			$this->byHref('modImmobilisations')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/immobilisations/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('immobilisations/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/immobilisations/admin/about.php');
		$this->authenticate();
		return $this->assertContains('immobilisations/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('immobilisationswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modImmobilisations_ImmobilisationsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modImmobilisations_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
