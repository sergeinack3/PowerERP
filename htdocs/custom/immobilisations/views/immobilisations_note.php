...
/**
 *  \file       immobilisations_note.php
 *  \ingroup    immobilisations
 *  \brief      Tab for notes on Immobilisations
 */
...
$hookmanager->initHooks(array('immobilisationsnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Immobilisations'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Immobilisations"), -1, $object->picto);
