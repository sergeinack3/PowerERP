...
/**
 *  \file       immobilisations_agenda.php
 *  \ingroup    immobilisations
 *  \brief      Tab of events on Immobilisations
 */
...
$hookmanager->initHooks(array('immobilisationsagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Immobilisations"), -1, $object->picto);
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnImmobilisations"), '', '');
