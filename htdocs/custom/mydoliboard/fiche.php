...
if ($action == 'add' && $user->rights->mydoliboard->creer) {
	...
	if (! $error) {
		...
		$object->xlstemplate	= GETPOST("xlstemplate");
...
if ($action == 'create' && $user->rights->mydoliboard->creer) {
	...
	// label
	print '<tr><td><span class="fieldrequired">'.$langs->trans("PageTitle").'</span></td>';
	...
	// TitleMenu
	print '<tr><td>'.$langs->trans("TitleMenu").'</td>';
	...
	// xlstemplate
	print '<tr><td>'.$langs->trans("XLSTemplate").'</td><td>'.select_xlstemplate("").'</td></tr>';
	...
	// langs
	print '<tr><td><span >'.$langs->trans("langfiles").'</span></td>';
	...
	// TitleMenu
	print '<tr><td><span class="fieldrequired">'.$langs->trans("MenuTitle").'</span></td>';
	...
	// elementtab
	print '<tr><td>'.$langs->trans("XLSTemplate").'</td><td>'.select_xlstemplate($object->xlstemplate).'</td></tr>';
	...
	print '<tr><td>'.$langs->trans("XLSTemplate").'</td><td >'.$object->xlstemplate.'</td></tr>';
	...
	print '<tr><td>'.$langs->trans("blocAmode").'</td>';
	print '<td >'.$langs->trans($object->blocAmode."mode").' : '.$object->blocAtitle.'</td></tr>';
	print '<tr><td>'.$langs->trans("blocBmode").'</td>';
	print '<td >'.$langs->trans($object->blocBmode."mode").' : '.$object->blocBtitle.'</td></tr>';
	print '<tr><td>'.$langs->trans("blocCmode").'</td>';
	print '<td >'.$langs->trans($object->blocCmode."mode").' : '.$object->blocCtitle.'</td></tr>';
	print '<tr><td>'.$langs->trans("blocDmode").'</td>';
	print '<td >'.$langs->trans($object->blocDmode."mode").' : '.$object->blocDtitle.'</td></tr>';
	...
	if ($user->rights->mydoliboard->creer)
		print '<a class="butAction" href="fiche.php?rowid='.$object->rowid.'&action=update">';
	else
	...
	if ($user->rights->mydoliboard->setup)
		print '<a class="butAction" href="fiche.php?rowid='.$object->rowid.'&action=importexport">';
	else
		print '<a class="butActionRefused" href="#" title="'.$langs->trans("NotAllowed").'">';
	print $langs->trans('ImportExport').'</a>';

	if ($user->rights->mydoliboard->supprimer)
		print '<a class="butAction" href="fiche.php?rowid='.$object->rowid.'&action=delete">';
	else
		print '<a class="butActionRefused" href="#" title="'.$langs->trans("NotAllowed").'">';
	...
	if ($user->rights->mydoliboard->creer) {
		print '<a class="butAction" href="board.php?pageid='.$object->rowid.'&action=create';
		print '&backtopage='.urlencode($_SERVER['PHP_SELF'].'?rowid='.$rowid).'">'.$langs->trans('NewBoard').'</a>';
	} else {
		print '<a class="butActionRefused" href="#" title="'.$langs->trans("NotOwnerOfProject").'">';
		print $langs->trans('NewBoard').'</a>';
	}
	print "</div>";
	print "</div>";
}
