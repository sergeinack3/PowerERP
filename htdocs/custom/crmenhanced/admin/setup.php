...
if ($action == 'update') {
    powererp_set_const($db, 'CRMENHANCED_MAIL_MODALITY', GETPOST('CRMENHANCED_MAIL_MODALITY', 'array')[0],'chaine',0,'',$conf->entity);
    powererp_set_const($db, 'CRMENHANCED_SMS_MODALITY', GETPOST('CRMENHANCED_SMS_MODALITY', 'array')[0],'chaine',0,'',$conf->entity);
    powererp_set_const($db, 'CRMENHANCED_DEFAULT_STATUS', GETPOST('CRMENHANCED_DEFAULT_STATUS', 'array')[0],'chaine',0,'',$conf->entity);
    powererp_set_const($db, 'CRMENHANCED_DEFAULT_OBJECT', GETPOST('CRMENHANCED_DEFAULT_OBJECT', 'array')[0],'chaine',0,'',$conf->entity);
}
