						...
						<tbody>
							<tr class="titre">
								<td class="nobordernopadding valignmiddle col-title">
									<div class="titre inline-block">COMMANDE DU CLIENT</div>
								</td>
							</tr>
						</tbody>
					</table>
...
if (empty($commande)) {
    ...
    while ($k < count($commande)) {
        ...
        print '
            <tr class="oddeven">
                <td class="nobordernopadding valignmiddle col-title">
                    <a href="../../commande/card.php?id=' . $commande[$k]->rowid . '">' . $commande[$k]->ref . '</a>
                </td>
                <td class="nobordernopadding valignmiddle col-title">
                    <a href="../../societe/card.php?id=' . $commande[$k]->fk_soc . '">' . getRefSoc(1) . '</a>
                </td>
                <td class="nobordernopadding valignmiddle col-title">
                    ' . date_format($date1, 'd M Y') . '
                </td>
                <td class="left">
                    <a class="butAction small" href="' . $_SERVER['PHP_SELF'] . '?id_commande=' . $commande[$k]->rowid . '&ref=' . $_POST['id_client'] . '">Afficher les transports</a>
                </td>
            </tr>
        ';
        $k++;
...
print '				<table class="centpercent notopnoleftnoright table-fiche-title showlinkedobjectblock">
						<tbody>
							<tr class="titre">
								<td class="nobordernopadding valignmiddle col-title">
									<div class="titre inline-block">TRANSPORT DE LA COMMANDE</div>
								</td>
							</tr>
						</tbody>
					</table>
						...
						<tbody>
                            <tr>
                                <form action="' . $_SERVER['PHP_SELF'] . '" method="POST">
                                    ...
                                    <td>
                                        <select style="width:100%;" name="id_commande" required>';
$l = 0;
