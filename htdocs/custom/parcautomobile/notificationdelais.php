...
?>
<ul class="custom-nav">
    <li id="delais" class="custom-nav-active"> Delais</li>
    <li id="notification"> Notification</li>
</ul>

<div>
    <div id="delais-container">
        <?php
        ...
        while ($cartegrise = $db->fetch_object($resql)) {
            ...
            if ($date_cartegrise  < $dateOfToday) {
                print '<br><span class="notif-error">La carte grise du ' . $vehicule_info->ref . ' est perimé &nbsp;&nbsp;<a target="_blank" href="vehicule_paper.php?id=' . $vehicule_info->rowid . '&veh_name=' . $vehicule_info->ref . '" class="notif-btn"><i class="fa fa-angle-right"></i></a></span><br><br>';
            } elseif ($day < $daylimit) {
                print '<br><span class="notif-error">La carte grise du ' . $vehicule_info->ref . ' va bientot perimer &nbsp;&nbsp;<a target="_blank" href="vehicule_paper.php?id=' . $vehicule_info->rowid . '&veh_name=' . $vehicule_info->ref . '" class="notif-btn"><i class="fa fa-angle-right"></i></a></span><br><br>';
            }
        }
        ...
        foreach ($All_vehicules as $veh) {
            $sql1 = 'SELECT * FROM ' . MAIN_DB_PREFIX . 'parcautomobile_assurance WHERE id_vehicule = ' . $veh->rowid;
            ...
            if ($db->num_rows($resql1) != 0) {
                ...
                if ($date_max_ass < $dateOfToday) {
                    print '<br><span class="notif-error">l`assurance du ' . $veh->ref . ' est perimé &nbsp;&nbsp;<a target="_blank" href="vehicule_paper.php?id=' . $veh->rowid . '&veh_name=' . $veh->ref . '" class="notif-btn"><i class="fa fa-angle-right"></i></a></span><br><br>';
                } elseif ($day < $daylimit) {
                    print '<br><span class="notif-error">l`assurance du ' . $veh->ref . ' va bientot perimer &nbsp;&nbsp;<a target="_blank" href="vehicule_paper.php?id=' . $veh->rowid . '&veh_name=' . $veh->ref . '" class="notif-btn"><i class="fa fa-angle-right"></i></a></span><br><br>';
                }
            }
        }
        ...
        foreach ($All_vehicules as $veh) {
            $sql2 = 'SELECT * FROM ' . MAIN_DB_PREFIX . 'parcautomobile_visitetechnique WHERE id_vehicule = ' . $veh->rowid;
            ...
            if ($db->num_rows($resql2) != 0) {
                ...
                if ($date_max_visit < $dateOfToday) {
                    print '<br><span class="notif-error">La visite technique du ' . $veh->ref . ' est perimé &nbsp;&nbsp;<a target="_blank" href="vehicule_paper.php?id=' . $veh->rowid . '&veh_name=' . $veh->ref . '" class="notif-btn"><i class="fa fa-angle-right"></i></a></span><br><br>';
                } elseif ($day < $daylimit) {
                    print '<br><span class="notif-error">La visite technique du ' . $veh->ref . ' va bientot perimer &nbsp;&nbsp;<a target="_blank" href="vehicule_paper.php?id=' . $veh->rowid . '&veh_name=' . $veh->ref . '" class="notif-btn"><i class="fa fa-angle-right"></i></a></span><br><br>';
                }
            }
        }
        ...
        foreach ($All_vehicules as $veh) {
            $sql3 = 'SELECT * FROM ' . MAIN_DB_PREFIX . 'parcautomobile_vignette WHERE id_vehicule = ' . $veh->rowid;
            ...
            if ($db->num_rows($resql3) != 0) {
                ...
                if ($date_max_vign < date('Y')) {
                    print '<br><span class="notif-error">La vignette du ' . $veh->ref . ' est perimé &nbsp;&nbsp;<a target="_blank" href="vehicule_paper.php?id=' . $veh->rowid . '&veh_name=' . $veh->ref . '" class="notif-btn"><i class="fa fa-angle-right"></i></a></span><br><br>';
                }
            }
        }
        ...
        if ($db->num_rows($resql4) != 0) {
            while ($item = $db->fetch_object($resql4)) {
                ...
                if ($item->type == 'defaillance') {
                    print '<br><span class="notif-error">Une defaillance signalee au ' . $vehicule_info2->ref . ' &nbsp;&nbsp;<a class="notif-btn" href="notificationdelais.php?id_regler=' . $item->rowid . '"><i class="fa fa-close"></i></a>&nbsp;&nbsp;<a target="_blank" href="vehicule_paper.php?id=' . $vehicule_info2->rowid . '&veh_name=' . $vehicule_info2->ref . '&id_show=' . $item->rowid . '" class="notif-btn"><i class="fa fa-angle-right"></i></a></span><br><br>';
                } else {
                    print '<br><span class="notif-success">Un entretien effectuee au ' . $vehicule_info2->ref . ' &nbsp;&nbsp;<a class="notif-btn" href="notificationdelais.php?id_regler=' . $item->rowid . '"><i class="fa fa-close"></i></a>&nbsp;&nbsp;<a target="_blank" href="vehicule_paper.php?id=' . $vehicule_info2->rowid . '&veh_name=' . $vehicule_info2->ref . '&id_show=' . $item->rowid . '" class="notif-btn"><i class="fa fa-angle-right"></i></a></span><br><br>';
                }
            }
        }
...
<script>
    ...
    const delaisContainer = document.getElementById('delais-container');
    const notificationContainer = document.getElementById('notification-container');

    delais.addEventListener("click", () => {
        delais.classList.add('custom-nav-active');
        notification.classList.remove('custom-nav-active');
        delaisContainer.style.display = "block";
        notificationContainer.style.display = "none";
    });
    notification.addEventListener("click", () => {
        delais.classList.remove('custom-nav-active');
        notification.classList.add('custom-nav-active');
        delaisContainer.style.display = "none";
