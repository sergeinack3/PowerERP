...
$hookmanager->initHooks(array('vehiculecontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permission = $user->rights->parcautomobile->vehicule->write;
} else {
	$permissiontoread = 1;
	$permission = 1;
}
