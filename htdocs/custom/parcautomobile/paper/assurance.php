...
print dol_get_fiche_head($head, 'assurance', $langs->trans("Vehicule"), -1, dol_buildpath('/parcautomobile/img/object_paper.png', 1), 1);
?>
    ...
    <tbody>
        <tr class="titre">
            <td class="nobordernopadding valignmiddle col-title">
                <div class="titre inline-block">Liste des assurances</div>
            </td>
        </tr>
    </tbody>
</table>
...
if ($db->num_rows($resql) == 0) {
    ...
    print ' <form action="' . $_SERVER['PHP_SELF'] . '?id=' . $vehicule_id . '&action=add_assurance" method="POST" class="st-form">
                <table class="centpercent notopnoleftnoright table-fiche-title showlinkedobjectblock">
                    <tbody>
                        <tr class="titre">
                            <td class="nobordernopadding valignmiddle col-title">
                                <div class="titre inline-block">Souscrire à une assurance</div>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <table class="border centpercent tableforfield">
                    <tbody>
                        ...
                        <tr>
                            <td class="titlefield">Categorie assurance</td>
                            <td class="valuefield">
                                <select class="select" name="category" id="category" required>
                                    ...
                                    <option value="Assurance tous risques">Assurance tous risques</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td class="titlefield">Date souscription</td>
                            <td class="valuefield"><input type="date" name="date_souscription" id="date-souscription" required></td>
                        </tr>
                        <tr>
    ...
    print ' <table class="noborder allwidth" data-block="showLinkedObject" data-element="booking" data-elementid="1">
                <tbody>
                    <tr class="liste_titre">
                        ...
                        <td class="left">Date de subscription</td>
                        <td class="left">Date expiration</td>
                    </tr>';
    ...
    while ($item = $db->fetch_object($resql)) {
        ...
        print '     <tr class="oddeven">
                        ...
                        <td class="left">' . $date3->format('d M Y') . '</td>
                        <td class="left">' . $date4->format('d M Y') . '</td>
                    </tr>';
    }
    print  '    </tbody>
            </table>';
    if ($date_max_ass < $dateOfToday) {
        print ' <br><span class="notif-error">La date limite de l\'assurance active est depassée !!</span>
                <form action="' . $_SERVER['PHP_SELF'] . '?id=' . $vehicule_id . '&action=add_assurance" method="POST" class="st-form">
                    <table class="centpercent notopnoleftnoright table-fiche-title showlinkedobjectblock">
                        <tbody>
                            <tr class="titre">
                                <td class="nobordernopadding valignmiddle col-title">
