...
/**
 *  \file       transport_note.php
 *  \ingroup    parcautomobile
 *  \brief      Tab for notes on Transport
 */
...
$hookmanager->initHooks(array('transportnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('Transport'), $help_url);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Transport"), -1, $object->picto);
