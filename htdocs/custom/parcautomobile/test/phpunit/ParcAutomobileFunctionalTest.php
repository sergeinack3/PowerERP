...
/**
 * \file    test/phpunit/ParcAutomobileFunctionalTest.php
...
/**
 * Class ParcAutomobileFunctionalTest
 *
 ...
 *
 * @package Testparcautomobile
 */
class ParcAutomobileFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modParcAutomobile')->click();
		} else {
			// Disable the module
			$this->byHref('modParcAutomobile')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/parcautomobile/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('parcautomobile/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/parcautomobile/admin/about.php');
		$this->authenticate();
		return $this->assertContains('parcautomobile/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('parcautomobilewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modParcAutomobile_ParcAutomobileTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modParcAutomobile_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
