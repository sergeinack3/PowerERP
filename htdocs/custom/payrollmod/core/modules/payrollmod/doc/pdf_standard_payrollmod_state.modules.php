...
/**
 *  \file       core/modules/payrollmod/doc/pdf_standard.modules.php
 *  \ingroup    payrollmod
...
/**
 *	Class to manage PDF template standard_payrollmod_state
 */
class pdf_standard_payrollmod_state extends ModelePDFPayrollmod_state
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_PAYROLLMOD_STATE_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->payrollmod->dir_output.'/payrollmod_state') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->payrollmod->dir_output.'/payrollmod_state';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->payrollmod->dir_output.'/payrollmod_state/'.$objectref;
