...
function getSmilies($path = "")
{
    $smilies=array(
                ...
                '(n)' => "<img class='smiley' src='".$path."img/smilies/dislike.png'>",
                'zzz' => "<img class='smiley' src='".$path."img/smilies/asleep.png'>",
                ':‑#' => "<img class='smiley' src='".$path."img/smilies/sick.png'>",
                ':‑o' => "<img class='smiley' src='".$path."img/smilies/scared.png'>"
	);
