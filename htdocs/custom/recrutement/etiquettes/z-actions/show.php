...
if( ($id && empty($action)) || $action == "delete" ){
    ...
    print '<form method="post" action="'.$_SERVER["PHP_SELF"].'" class="ettiq_recrut">';
    ...
    print '<table class="border" width="100%">';
        ...
        print '<tbody>';
            print '<tr>';
                print '<td style="width:20% !important">'.$langs->trans('label_etiquette');
                print '<td style="width:80% !important">'.$item->label.'</td>';
            print '</tr>';
            print '<tr>';
                print '<td >'.$langs->trans('color');
                print '<td><span class="ettiq" style="background-color:'.$item->color.';">'.$item->color.'</span></td>';
            print '</tr>';
