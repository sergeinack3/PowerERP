...
require_once '../lib/recrutement.lib.php';
...
$head = recrutementAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
...
dol_include_once('recrutement/www/class/context.class.php');
