...
class modfactory extends PowerERPModules
{
	...
	function __construct($db)
	{
		...
		$this->module_parts = array(
			'hooks' => array('searchform', 'element_resource', 'productdao'),
			'tpllinkable' => 1,
			'contactelement' => 1,
			'models' => 1
		);
		...
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=products,fk_leftmenu=factory',
					...
					'titre'=>'CreateOFShort',
					'mainmenu'=>'', 'leftmenu'=>'',
					'url'=>'/factory/fiche.php?action=add',
					'langs'=>'factory@factory',
					'position'=>110, 'enabled'=>'1',
					'perms'=>'1', 'target'=>'',
					'user'=>2);
...
//		$r++;
		...
		$this->tabs = array(
			...
			, 'order:+factory:Factory:@order:/factory/tabs/factoryorder.php?id=__ID__'
			, 'propal:+factory:Factory:@propal:/factory/tabs/factorypropal.php?id=__ID__'
