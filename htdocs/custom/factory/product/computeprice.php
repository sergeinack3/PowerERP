 ...
 * Copyright (C) 2019		Charlene BENKE			<charlie@patas-monkey.com>
 *
...
if (GETPOST("coefmargin"))
	...
	$computepricedefaultcoef = $conf->global->factory_computepricedefaultcoef;
...
if ($action == '' && $bproduit) {
	...
	if ($user->rights->factory->creer) {
		//Le stock doit être actif et la nature du produit est manufacturée
