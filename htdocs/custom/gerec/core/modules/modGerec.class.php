...
/**
 * 	\defgroup   mymodule     Module Gerec
 *  \brief      Gestionnaire de Grille de remises par client..
 *				
 *  \file       htdocs/[custom/]gerec/core/modules/modGerec.class.php
 *  \ingroup    Gerec
 *  \brief      Description and activation file for module Gerec
 */
 ...
 */
class modGerec extends PowererpModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->description = "Gestionnaire de la grille de remises clients";
		...
		//                        );
		$this->module_parts = array('triggers' => 1, 'css'=>"/".strtolower($this->name)."/css/".strtolower($this->name).".css");
		...
		// $this->config_page_url = array("setup.php@gerec");
		...
		$this->langfiles = array("gerec@gerec");
		...
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=products',
									'type'=>'left',
									'titre'=>'Remises Clients',
									'mainmenu'=>'',
									'leftmenu'=>'',
									'url'=>'/gerec/grille.php',
									'langs'=>'gerec@gerec',
									'position'=>50,
									'enabled'=>'1',
									'perms'=>'1',
