...
FIX autoopen of the "switch entity popup" was broken (used by PowerDroid)
...
- This is required to provide a compatibility with native android application when menu is not managed by PowerERP but by the android application  
...
FIX compatibility with PowerERP 8  
...
Fix: datatables error when "multicompany" directory is in root of powererp  
...
Fix: compatibility with PowerERP 7  
...
Fix: compatibility with PowerERP 6  
...
Fix: compatibility with PowerERP 5  
New: add expense report sharing

## 4.0.0

Fix: compatibility with PowerERP 4  
...
Fix: compatibility with PowerERP 3.8.x
...
Fix: compatibility with PowerERP 3.7.x  
...
Fix: compatibility with PowerERP 3.6.x  
...
Fix: compatibility with PowerERP 3.5.0
...
Fix: compatibility with PowerERP 3.4  
...
this happened during an update of a version of PowerERP < 3.1 to >= 3.1
