 ...
 *
 *	@return int		0 = OK
 *					1 = Multicompany is older than PowerERP
 *					-1 = PowerERP is older than MultiCompany
...
function checkMultiCompanyVersion()
{
	...
	if (empty($conf->global->MULTICOMPANY_MAIN_VERSION) || (version_compare(DOL_VERSION[0], '8', '=') && $conf->global->MULTICOMPANY_MAIN_VERSION < '8.0.0')) {
			return -2;
	} else {
		//return version_compare(DOL_VERSION[0], '8');
		return 0;
	}
}
