...
print dol_get_fiche_head($head, 'options', $langs->trans("ModuleSetup"), -1);
...
if ($checkconfig !== true) {
	...
	print '<div id="dol_hide_login_combobox_error"'.($hidden ? ' style="display:none;"' : '').'>'.get_htmloutput_mesg($langs->trans("ErrorPowerERPConfAuthentication"),'','error',1).'</div>';
}
