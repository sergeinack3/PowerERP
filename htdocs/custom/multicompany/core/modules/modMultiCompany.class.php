...
class modMultiCompany extends PowerERPModules
{
	...
	function __construct($db)
	{
		...
		$this->need_powererp_version = array(8,0,0);	// Minimum version of PowerERP required by module
		...
		$this->rights[$r][1] = 'Consulter les environnements (For superadmin users)';
		$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		...
		$this->rights[$r][1] = 'Modifier les environnements (For superadmin users)';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		...
		$this->rights[$r][1] = 'Supprimer les environnements (For superadmin users)';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		...
		$this->rights[$r][1] = 'Consulter les tiers partagés';
		$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		...
		$this->rights[$r][1] = 'Modifier les tiers partagés';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'thirdparty';
		...
		$this->rights[$r][1] = 'Supprimer les tiers partagés';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'thirdparty';
		...
		$this->rights[$r][1] = 'Consulter les contacts partagés';
		$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		...
		$this->rights[$r][1] = 'Modifier les contacts partagés';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'contact';
		$this->rights[$r][5] = 'write';
		...
		$this->rights[$r][1] = 'Supprimer les contacts partagés';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'contact';
		$this->rights[$r][5] = 'delete';
		...
		$this->rights[$r][1] = 'Consulter les produits/services partagés';
		$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		...
		$this->rights[$r][1] = 'Modifier les produits/services partagés';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'product';
		$this->rights[$r][5] = 'write';
		...
		$this->rights[$r][1] = 'Supprimer les produits/services partagés';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'product';
		$this->rights[$r][5] = 'delete';
		...
		$this->rights[$r][1] = 'Consulter les propositions commerciales partagées';
		$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		...
		$this->rights[$r][1] = 'Modifier les propositions commerciales partagées';
		$this->rights[$r][2] = 'w';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'propal';
		$this->rights[$r][5] = 'write';
		...
		$this->rights[$r][1] = 'Valider les propositions commerciales partagées';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		...
		$this->rights[$r][1] = 'Envoyer les propositions commerciales partagées';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'propal_advance';
		...
		$this->rights[$r][1] = 'Clôturer les propositions commerciales partagées';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'propal';
		...
		$this->rights[$r][1] = 'Supprimer les propositions commerciales partagées';
		$this->rights[$r][2] = 'd';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'propal';
		$this->rights[$r][5] = 'delete';
