...
insert into llx_const (name, value, type, note, visible, entity) values ('MAIN_MAIL_EMAIL_FROM','powererp@ipowerworld.net','chaine','EMail emetteur pour les emails automatiques PowerERP',0,__ENTITY__);
...
-- Mail Mailing
--
insert into llx_const (name, value, type, note, visible, entity) values ('MAILING_EMAIL_FROM','powererp@ipowerworld.net','chaine','EMail emmetteur pour les envois d emailings',0,__ENTITY__);
