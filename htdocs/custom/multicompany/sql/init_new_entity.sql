...
insert into llx_const (name, value, type, note, visible, entity) values (__ENCRYPT('MAIN_MAIL_EMAIL_FROM')__,__ENCRYPT('powererp@ipowerworld.net')__,'chaine','EMail emetteur pour les emails automatiques PowerERP',0,__ENTITY__);
...
-- Mail Mailing
--
insert into llx_const (name, value, type, note, visible, entity) values (__ENCRYPT('MAILING_EMAIL_FROM')__,__ENCRYPT('powererp@ipowerworld.net')__,'chaine','EMail emmetteur pour les envois d emailings',0,__ENTITY__);
