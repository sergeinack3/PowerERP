...
class CreatePage extends FormPage
{
	 ...
	 * @param     $is_required           is field required or not
	 * @param     $field_summary         field summary
	 * @param     $toolbarname           Editor toolbar name, values: 'Full', powererp_details', 'powererp_notes', 'powererp_mailings', 'powererp_readonly'
	 * @param     $height                text area height
	 * @param     $valign                field vertical align
	 * @return    $this
	 */
	public function addTextAreaField($field_name, $text_area_name, $text_area_value = '', $is_required = false, $field_summary = '', $toolbarname = 'powererp_details', $height = 100, $valign = 'top')
	{
