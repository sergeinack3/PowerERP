...
require_once '../lib/gestionpannes.lib.php';
...
$head = gestionpannesAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Gestiondespannes"),
    0,
...
dol_include_once('gestionpannes/www/class/context.class.php');
...
if(empty($conf->global->EACCESS_RGPD_MSG)){
    powererp_set_const($db,'EACCESS_RGPD_MSG',$langs->trans('EACCESS_RGPD_MSG_default',$conf->global->MAIN_INFO_SOCIETE_NOM), 'chaine', 0, '', $conf->entity) ;
}
