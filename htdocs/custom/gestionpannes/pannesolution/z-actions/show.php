...
if ($action == 'confirm_delete' && GETPOST('confirm') == 'yes' ) {
    ...
    $pannesolution->fetch($id);
   // $Project->fetch($id);/////////////
    $error = $pannesolution->delete();
...
if( ($id && empty($action)) || $action == "delete" ){
    ...
    print '<tbody>';
    print '<tr>';
        print '<td >'.$langs->trans('Ref_l').'';
        print '<td>'.$item->rowid.'</td>';
    print '</tr>';
    print '<tr>';
        print '<td >'.$langs->trans('solution').'';
        print '<td>'.$item->solution.'</td>';
    print '</tr>';
          print '<tr>';
    ...
    print '</tr>';
      print '<tr>';
        ...
        print '<td>'.$item->recomandation.'</td>';
    print '</tr>';
        print '<tr>';
        print '<td >'.$langs->trans('etat').'';
        print '<td>'.$item->etat.'</td>';
    print '</tr>';
