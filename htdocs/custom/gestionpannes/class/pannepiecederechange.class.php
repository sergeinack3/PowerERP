...
class pannepiecederechange extends Commonobject{ 

	public $errors = array();
	public $rowid;
	public $ref;

	public $element='pannepiecederechange';
	public $table_element='pannepiecederechange';
...
// die($sql);
	...
	public function fetchAll($sortorder = '', $sortfield = '', $limit = 0, $offset = 0, $filter = '', $filtermode = 'AND',$pannesrch='')
	{
		dol_syslog(__METHOD__, LOG_DEBUG);
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				...
				$line->date_remplacement 	= $obj->date_remplacement;
				$line->commantaire 	= $obj->commantaire;
		...
		if ($resql) {
			...
			if ($numrows) {
				$obj 			= $this->db->fetch_object($resql);
					...
					$this->piecederechange 	= $obj->piecederechange;
					$this->matreil_id 	= $obj->matreil_id;
					$this->quantite 	= $obj->quantite;
					$this->date_remplacement 	= $obj->date_remplacement;
					$this->commantaire 	= $obj->commantaire;
    ...
    function getNomUrl($withpicto=0, $option='', $get_params='', $notooltip=0, $save_lastsearch_value=-1)
    {
        ...
        $result='';
        $label='';
        $url=dol_buildpath('/gestionpannes/pannepiecederechange/card.php?id='.$this->rowid,2);
