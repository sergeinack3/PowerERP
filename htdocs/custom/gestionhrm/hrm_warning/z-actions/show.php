...
if($action == 'update'){
    ...
    $warning->fetch($id);
    $isvalid = $warning->update($id, $data);
...
if($id || $action == "delete" ){
    ...
    $warning->fetchAll('','',0,0,' and rowid = '.$id);
    $item = $warning->rows[0];
    ...
    print '<form method="post" action="'.$_SERVER["PHP_SELF"].'" class="form_gestionhrm">';
        ...
        print '<table class="noborder nc_table_" width="100%">';
                ...
                print '<tr>';
                    print '<td>'.$langs->trans("warningby").'</td>';
                    print '<td>';
                        if($item->warningby){
                            $employe = new User($db);
                            $employe->fetch($item->warningby);
                ...
                print '<tr>';
                    print '<td>'.$langs->trans("against_wrn").' </b>';
                    print '<td>';
                        if($item->against){
    ...
    print '<form method="post" action="'.$_SERVER["PHP_SELF"].'">';
        ...
        print '<div aria-hidden="false" '.$cl.' aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="moadl_adttend" class="fade in" align="center">';
            print '<div class="div_request">';
                ...
                print '<table class="tbl_hrm table_warning">';
                    ...
                    print '<tr>';
                        ...
                        print '<td>';
                            print $form->select_dolusers($item->warningby, 'warning', 1, '', 0, '', '', 0, 0, 0, '', 0, '', 'warning',true);
                        print '</td>';
                    print '</tr>';
                    ...
                    print '<tr>';
                        ...
                        print '<td>'.$warning->select_user($against,'against',1,1).'</td>';
                    print '</tr>';
    ...
    $relativepathwithnofile = '/warning/'.$id.'/';
