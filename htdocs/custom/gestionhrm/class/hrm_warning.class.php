...
class hrm_warning extends Commonobject{ 
	...
	public $element='hrm_warning';
	public $table_element='hrm_warning';
    ...
    function getNomUrl($withpicto=0, $option='', $get_params='', $notooltip=0, $save_lastsearch_value=-1)
    {
        ...
        $result='';
        $label='';
        $url = dol_buildpath('/gestionhrm/hrm_warning/card.php?id='.$this->id,2);
        ...
        if ($ref) {
            ...
            $result .= $linkstart;
            if ($withpicto) 
                $result.= '<img height="16" src="'.dol_buildpath('/gestionhrm/img/icon_hrm_warning.png',2).'" >&nbsp;';
