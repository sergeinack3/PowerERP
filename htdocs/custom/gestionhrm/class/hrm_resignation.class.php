...
class hrm_resignation extends Commonobject{ 
	...
	public $element='hrm_resignation';
	public $table_element='hrm_resignation';
    ...
    function getNomUrl($withpicto=0, $option='', $get_params='', $notooltip=0, $save_lastsearch_value=-1)
    {
        ...
        $result='';
        $label='';
        $url = dol_buildpath('/gestionhrm/hrm_resignation/card.php?id='.$this->id,2);
        ...
        if ($ref) {
            ...
            $result .= $linkstart;
            if ($withpicto) 
                $result.= '<img height="16" src="'.dol_buildpath('/gestionhrm/img/icon_hrm_resignation.png',2).'" >&nbsp;';
