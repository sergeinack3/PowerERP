...
class hrm_promotion extends Commonobject{ 
	...
	public $element='hrm_promotion';
	public $table_element='hrm_promotion';
    ...
    function getNomUrl($withpicto=0, $option='', $get_params='', $notooltip=0, $save_lastsearch_value=-1)
    {
        ...
        $result='';
        $label='';
        $url = dol_buildpath('/gestionhrm/hrm_promotion/card.php?id='.$this->id,2);
        ...
        if ($ref) {
            ...
            $result .= $linkstart;
            if ($withpicto) 
                $result.= '<img height="16" src="'.dol_buildpath('/gestionhrm/img/object_gestionhrm.png',2).'" >&nbsp;';
