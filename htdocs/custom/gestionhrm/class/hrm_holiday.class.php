...
class hrm_holiday extends Commonobject{ 
	...
	public $element='hrm_holiday';
	public $table_element='hrm_holiday';
    ...
    function getNomUrl($withpicto=0, $option='', $get_params='', $notooltip=0, $save_lastsearch_value=-1)
    {
        ...
        $result='';
        $label='';
        $url = dol_buildpath('/gestionhrm/hrm_holiday/card.php?id='.$this->id,2);
        ...
        if ($ref) {
            ...
            $result .= $linkstart;
            if ($withpicto) 
                $result.= '<img height="16" src="'.dol_buildpath('/gestionhrm/img/icon_hrm_holiday.png',2).'" >&nbsp;';
