...
if( $id  || $action == "delete" ){
    ...
    print '<form method="post" action="'.$_SERVER["PHP_SELF"].'" class="form_gestionhrm">';
        ...
        print '<table class="noborder nc_table_" width="100%">';
                ...
                print '<tr>';
                    ...
                    print '<td>'.number_format($item->amount,2,',',' ').' ('.$conf->currency.') </td>';
                print '</tr>';
    ...
    print '<form method="post" action="'.$_SERVER["PHP_SELF"].'">';
        ...
        print '<div aria-hidden="false" '.$cl.' aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="moadl_adttend" class="fade in" align="center">';
            print '<div class="div_request">';
                ...
                print '<table class="tbl_hrm table_award">';
                    ...
                    print '<tr>';
                        print '<td>'.$langs->trans("award_amount").' </b>';
                        print '<td colspan="3"><input type="number" step="0.01" name="amount" value="'.$item->amount.'" autocomplete="off"  >('.$conf->currency.')</td>';
                    print '</tr>';
    ...
    $relativepathwithnofile = '/award/'.$id.'/';
