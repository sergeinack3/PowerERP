...
class etapescandidature extends Commonobject{ 
	...
	public $element='etapescandidature';
	public $table_element='etapescandidature';
	...
	public function create($echo_sql=0,$insert)
	{
		...
		return $this->db->last_insert_id(MAIN_DB_PREFIX.'etapescandidature');
	}
