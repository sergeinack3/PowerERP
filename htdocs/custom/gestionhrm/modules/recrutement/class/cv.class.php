...
class cv_recrutement extends Commonobject{ 
	...
	public $element='cv_recrutement';
	public $table_element='cv_recrutement';
	...
	public function create($echo_sql=0,$insert)
	{
		...
		return $this->db->last_insert_id(MAIN_DB_PREFIX.'cv_recrutement');
	}
	...
	public function fetchAll($sortorder = '', $sortfield = '', $limit = 0, $offset = 0, $filter = '', $filtermode = 'AND')
	{
		...
		if ($resql) {
			...
			while ($obj = $this->db->fetch_object($resql)) {
				...
				$line->type 		 =  $obj->type;
				$line->date 		 =  $obj->date;
				$line->fichier 		 =  $obj->fichier;
				$line->poste 			 =  $obj->poste;
				$line->candidature 			 =  $obj->candidature;
                // ....
	...
	public function fetch($id)
	{
		...
		if ($resql) {
			...
			if ($numrows) {
                ...
                $this->type        	  = $obj->type;
                $this->date        	  = $obj->date;
                $this->fichier        	  = $obj->fichier;
                $this->poste       	  = $obj->poste;
                $this->candidature    = $obj->candidature;
