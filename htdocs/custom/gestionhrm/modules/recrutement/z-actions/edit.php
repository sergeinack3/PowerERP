...
if($action == "edit"){
    ...
    print '<form method="post" action="'.$_SERVER["PHP_SELF"].'" enctype="multipart/form-data" class="posterecrutement recrutmodule">';
    ...
    //         print '<a class="butAction butActionDelete" style="background: #eae4e1; float: right;" data-id="'.$item->rowid.'" id="arret" >'.$langs->trans('arrete').'</a>';
    //     }
    //     else
    ...
    print '<div class="fichehalfleft">';
        ...
        print '<table class="border nc_table_ ncrecrutementtab" width="100%">';
            // print '<thead>';
            ...
            print '<tr>';
                ...
                print '<td >'.$poste->select_user($item->responsable_recrutement,'responsable_recrutement',1,"rowid","login").'</td>';
            print '</tr>';
    ...
    print '<div class="ficheaddleft">';
        ...
        print '<div class="divrectrubuttonaction">';
            if($item->status == "Recrutementencours"){
                ...
                print '<a class="butAction butActionDelete" style="background: #eae4e1;color:#633 !important;font-weight:bold;" data-id="'.$item->rowid.'" id="finaliser2" href="./card.php?id='.$id.'&etat=finaliser">'.$langs->trans('finaliserrecru').'</a>';
            }
            else
