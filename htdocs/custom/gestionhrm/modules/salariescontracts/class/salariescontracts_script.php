...
/**
 *      \file       salariescontracts/salariescontracts_script.php
...
// Examples for manipulating class salariescontracts_class
// require_once(DOL_DOCUMENT_ROOT."/../salariescontracts/salariescontracts.class.php");
require_once dol_buildpath('/salariescontracts/class/salariescontracts.class.php');
$myobject=new Salariescontracts($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."salariescontracts";
