...
class pdf_ultimate_receipt extends ModelePDFDeliveryOrder
{
	...
	*/
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		if ($conf->expedition->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				$tab_top_newpage = (empty($conf->global->ULTIMATE_RECEIPT_PDF_DONOTREPEAT_HEAD) ? $this->marge_haute + $logo_height + $top_shift + 10 : 10);
				
				$tab_height = 130 - $top_shift;
				$tab_height_newpage = 150;
				if (empty($conf->global->ULTIMATE_RECEIPT_PDF_DONOTREPEAT_HEAD)) $tab_height_newpage -= $top_shift;
    ...
    public function defineColumnField($object,$outputlangs,$hidedetails=0,$hidedesc=0,$hideref=0)
    {
		...
		if (!empty($conf->global->ULTIMATE_RECEIPTS_WITH_LINE_NUMBER) || ($conf->global->ULTIMATE_DOCUMENTS_WITH_REF == "yes" && $this->atleastoneref==true))
	    {
