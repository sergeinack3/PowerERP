            ...
            <div class="border" style="width:100%;background-color:white;padding:1rem;">
                <table class="border" style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="supplier[phone]" style="width:100%;" value="<?= htmlspecialchars(strip_tags($supplier['phone'])) ?>" /></td>
                    </tr>
                    <tr>
                        <td class="titlefield"><?= $langs->trans('purchasesEmail') ?></td>
                        <td><input type="text" name="supplier[email]" style="width:100%;" value="<?= htmlspecialchars(strip_tags($supplier['email'])) ?>" /></td>
                    </tr>
                    <tr>
                        <td class="titlefield"><?= $langs->trans('purchasesAddress') ?></td>
                        <td><textarea name="supplier[address]" style="width:100%;height:4em;"><?= strip_tags($supplier['address']) ?></textarea></td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    function js_validate_form(form_id){
        ...
        /* submit form */
            if (all_fine){
                ...
                alert("<?= str_replace('"','\"',  html_entity_decode($langs->trans('purchasesErrorMsg05'))) ?>");
            }
