<?php
    ...
    if ($action == 'create' && $request_method === 'POST') {
        ...
        if ($avance > 0 ) {
            ...
            header('Location: card.php?action=request&error=SQL_Create&msg='.$approbation->error);
            exit;
        }
    }
    ...
    if($action == "add"){
        ...
        print '<form method="post" action="'.$_SERVER["PHP_SELF"].'" enctype="multipart/form-data" class="approbmodule">';
        ...
        print '<div class="fichehalfleft">';
            ...
            print '<table class="border nc_table_" width="100%">';
                ...
                print '<tr>';
                    ...
                    print '<td >'.$poste->select_user(0,'responsable_approbation',1,"rowid","login").'</td>';
                print '</tr>';
