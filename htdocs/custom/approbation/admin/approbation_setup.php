...
require_once '../lib/approbation.lib.php';
...
$head = approbationAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
...
dol_include_once('approbation/www/class/context.class.php');
