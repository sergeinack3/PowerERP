...
$filter .= (!empty($fk_user)? " AND fk_user =".$fk_user :"");
...
// print '<a href="./mesapprobations/add_demande.php?action=add" class="butAction" >'.$langs->trans("Add").'</a>';
// print '</div>';

 	print '<div style="float: left; margin-bottom: 8px; width:100%;">';
      // print '<div style="width:10%; float:left;" >';
      //     print '<a class="icon_list" data-type="list" href="'.dol_buildpath('/approbation/list.php',2).'"> <img  src="'.dol_buildpath('/approbation/img/list.png',2).'" style="height:30px" id="list" ></a>';
      //     print '<a class="icon_list" data-type="grid" href="'.dol_buildpath('/approbation/mesapprobations/index.php',2).'"> <img src="'.dol_buildpath('/approbation/img/grip.png',2).'" style="height:30px" id="grid" ></a> ';
      // print '</div>';
      ...
      print '</div>';
       ...
       print '<div style="width:15%; float:right; text-align:right;">';
          print '<a href="./mesapprobations/dashboard.php" class="butAction" id="add" align="right" >'.$langs->trans("Add").'</a>';
      print '</div>';
  	print '</div>';
...
print_liste_field_titre($langs->trans("Request_Owner"), $_SERVER["PHP_SELF"], "fk_user", "", $param, 'align="center"', $sortfield, $sortorder);
...
print '<tr class="liste_titre nc_filtrage_tr">';
	...
	// print '<td align="center" class="date"><input style="width:120px !important" type="text" value="'.$srch_date.'" name="srch_date" class="datepicker" ></td>';

	print '<td align="center" class="user" style="width:100px !important" >';
		$form->select_users($srch_fk_user, "srch_fk_user",1);
	print '</td>';
	...
	if (count($demandes->rows) > 0) {
		for ($i=0; $i < count($demandes->rows) ; $i++) {
			...
			print '<tr '.$bc[$var].' >';
	    		...
	    		print '</td>';
	    // 		print '<td align="center" style="">'; 
	    // 		if($type->champ_date != "Aucun" ){
					// $date =($item->date? date('d/m/Y H:i',strtotime($item->date)):'');
	    // 			print $date;
	    // 		}
	    // 		print '</td>';
	    		print '<td align="center" style="">'; 
