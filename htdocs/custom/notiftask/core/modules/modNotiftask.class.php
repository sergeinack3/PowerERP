 ...
 */
class modNotiftask extends PowerERPModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->description = $langs->trans("descripcio_notiftask");
		...
		//$this->config_page_url = array("mysetuppage.php@Notiftask");
		...
		$this->langfiles = array("notiftask@notiftask");
        ...
        // Dictionnaries
	    if (! isset($conf->Notiftask->enabled))
        {
        	$conf->Notiftask=new stdClass();
        	$conf->Notiftask->enabled=0;
        }
	...
	function init($options='')
	{
		...
		$result=$this->_load_tables('/notiftask/sql/');
