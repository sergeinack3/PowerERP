...
<html style="height: 100%; overflow: hidden;" xmlns="http://www.w3.org/1999/xhtml">
	...
	<title><?php echo $langs->trans("PowerERPTPV"); ?></title>
	...
	<div data-role="footer" data-id="pageFooter" data-theme="b" data-position="fixed">
    	<div data-role="navbar" class="nav-glyphish-example" >
			<ul>
				...
				<li><a href="#cart" id="cart" data-icon="custom"><?php echo $langs->trans("tickets"); ?></a></li>
...
<div data-role="page" id="cart" data-theme="b">
	<div data-role="header" data-id="pageHeader" data-theme="b" >
		<h3><a href="#infocart" onclick="_TPV.tickets.editInfotickets();"  data-icon="grid"><span id="placeName"></span> - <span id="totaltickets"></span> <?php echo $conf->currency ?></a></h3>
	</div>
	<div data-role="content">
	<ul id="ticketsCart" data-theme="c" data-role="listview"></ul>
    ...
    <div data-role="navbar" class="nav-glyphish-example" >
			<ul>
				...
				<?php }?>
				<li><a href="#" id="btnSavetickets" data-icon="star"><?php echo $langs->trans("Send"); ?></a></li>
			</ul>
	</div>
   </div>
</div>
...
<div data-role="page" id="productEdit" data-theme="b">
    ...
    <div data-role="navbar" class="nav-glyphish-example" >
			<ul>
				...
				<li><a href="#" id="saveticketsLine" data-icon="star"><?php echo $langs->trans("Save"); ?></a></li>
			</ul>
		</div>
   </div>
</div>
...
<div data-role="page" id="infocart" data-theme="b">
	...
	<div data-role="content">
	<label for="ticketsnotes"><?php echo $langs->trans("Note"); ?></label>
	<input id="ticketsnotes" type="text" value="" placeholder="<?php echo $langs->trans("Note"); ?>" name="ticketsnotes">
    ...
    <div data-role="navbar" class="nav-glyphish-example" >
			<ul>
				...
				<li><a id="btnSaveInfotickets" data-icon="star"><?php echo $langs->trans("Save"); ?></a></li>
			</ul>
	</div>
   </div>
</div>
