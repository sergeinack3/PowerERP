 ...
 */
	...
	,	defaults: { // default options for 'all panes' - will be overridden by 'per-pane settings'
		...
		,	preventQuickSlideClose:	!!($.browser.webkit || navigator.userAgent.indexOf('Safari') != -1) // Chrome triggers slideClosed as is opening
 ...
 */
	...
	*/
	var _create = function () {
		...
		,	webkit:		$.browser.webkit || navigator.userAgent.indexOf('Safari') != -1
		,	msie:		$.browser.msie
