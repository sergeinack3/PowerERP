...
$nom=$langs->trans("ticketsSellsJournal");
$nomlink='';
$periodlink='';
$exportlink='';
$builddate=time();
$description=$langs->trans("ticketsDescSellsJournal").'<br>';
...
$sql = "SELECT f.rowid, f.ticketsnumber, f.type, f.date_closed,";
...
$sql.= " FROM ".MAIN_DB_PREFIX."pos_ticketsdet fd";
$sql.= " LEFT JOIN ".MAIN_DB_PREFIX."product p ON p.rowid = fd.fk_product";
$sql.= " JOIN ".MAIN_DB_PREFIX."pos_tickets f ON f.rowid = fd.fk_tickets";
	...
	$num = $db->num_rows($result);
   	...
   	while ($i < $num)
   	{
    	...
    	//la ligne facture
   		...
   		$tabfac[$obj->rowid]["ref"] = $obj->ticketsnumber;
...
print '<td>'.$langs->trans('Date').'</td><td>'.$langs->trans('Piece').' ('.$langs->trans('ticketsInvoiceRef').')</td>';
