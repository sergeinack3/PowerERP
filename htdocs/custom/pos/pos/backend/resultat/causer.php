 ...
 *       \brief       Page tickets reporting  by user
 */
...
$sql = "SELECT s.rowid as socid, s.lastname, s.firstname, sum(if(f.type=1,f.total_ht * -1,f.total_ht)) as amount, sum(if(f.type=1,f.total_ttc * -1,f.total_ttc)) as amount_ttc";
