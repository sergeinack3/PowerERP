...
/**
 * \file    test/phpunit/EmpruntFunctionalTest.php
 * \ingroup emprunt
 ...
 * @package Testemprunt
 */
class EmpruntFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/emprunt/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('emprunt/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/emprunt/admin/about.php');
		$this->authenticate();
		return $this->assertContains('emprunt/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('empruntwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEmprunt_EmpruntTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEmprunt_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
