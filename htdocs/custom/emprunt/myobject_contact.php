...
/**
 *  \file       emprunt/myobject_contact.php
 *  \ingroup    emprunt
...
dol_include_once('/emprunt/class/myobject.class.php');
dol_include_once('/emprunt/lib/emprunt_myobject.lib.php');
...
$permission = $user->rights->emprunt->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/emprunt/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
