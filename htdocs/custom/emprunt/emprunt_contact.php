...
/**
 *  \file       emprunt_contact.php
 *  \ingroup    emprunt
 *  \brief      Tab for contacts linked to Emprunt
 */
...
$hookmanager->initHooks(array('empruntcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->emprunt->emprunt->write;
...
$title = $langs->trans('Emprunt')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
