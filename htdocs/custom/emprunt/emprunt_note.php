...
/**
 *  \file       emprunt_note.php
 *  \ingroup    emprunt
 *  \brief      Tab for notes on Emprunt
 */
...
$hookmanager->initHooks(array('empruntnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permissiontoadd = $user->rights->emprunt->emprunt->write; // Used by the include of actions_addupdatedelete.inc.php
...
$help_url = '';
llxHeader('', $langs->trans('Emprunt'), $help_url);
