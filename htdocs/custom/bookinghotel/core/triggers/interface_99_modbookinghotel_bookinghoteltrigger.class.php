...
/**
 * 	\file		core/triggers/interface_99_modMyodule_bookinghoteltrigger.class.php
 * 	\ingroup	bookinghotel
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modBookingHotel_Mytrigger.class.php
 ...
 * Trigger class
 */
class Interfacebookinghoteltrigger
{
    ...
    public function run_trigger($action, $object, $user, $langs, $conf)
    {
        ...
        if ($action == 'BILL_DELETE') {
            $sql = $this->db->query('UPDATE '.MAIN_DB_PREFIX.'bookinghotel SET fk_facture=NULL WHERE fk_facture='.$object->id);
