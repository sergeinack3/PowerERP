...
/**
 *	\file	   	htdocs/process/action/fullcalendar.php
 *	\ingroup		process
 *	\brief	  	Page of action fullcalendar view
 */
...
$title=$langs->trans("CalendarProcess")." - ".$langs->trans("Events");
...
print '<th  align=left >'.$langs->trans("Events").'</th>';
print "</tr>\n";
...
print '<td valign=top>';
print '<table><tr><td width=100px>'.$langs->trans("Users");
...
print "window.open('".dol_buildpath("/process/action/", 1);
...
print "	$.ajax({\n";
print "url: '".dol_buildpath("/process/action/ajax/", 1);
...
print "	var end = $.fullCalendar.formatDate(event.end, 'Y-MM-DD HH:mm:ss');\n";
print 'else';
print "	var end = $.fullCalendar.formatDate(event.start, 'Y-MM-DD HH:mm:ss');\n";
