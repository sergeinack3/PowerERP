...
if ($event->type == 'payout.created') {
	...
	$result = powererp_set_const($db, $service."_NEXTPAYOUT", date('Y-m-d H:i:s', $event->data->object->arrival_date), 'chaine', 0, '', $conf->entity);
	...
	global $conf;
	$error = 0;
	$result = powererp_set_const($db, $service."_NEXTPAYOUT", null, 'chaine', 0, '', $conf->entity);
	if ($result) {
		$langs->load("errors");
