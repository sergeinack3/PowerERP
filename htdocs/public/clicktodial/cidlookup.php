 ...
 *
 *              exten => s,1,Set(CALLERID(name)=${CURL(http://IP-POWERERP:80/asterisk/cidlookup.php?phone=${CALLERID(num)}&securitykey=SECURITYKEY)})
 *
 *			    Change IP-POWERERP to the IP address of your powererp server
