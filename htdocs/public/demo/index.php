...
if (!defined('NOIPCHECK')) {
	define('NOIPCHECK', '1'); // Do not check IP defined into conf $powererp_main_restrict_ip
}
...
// Security check
global $powererp_main_demo;
if (empty($powererp_main_demo)) {
	httponly_accessforbidden('Parameter powererp_main_demo must be defined in conf file with value "default login,default pass" to enable the demo entry page');
}
...
if (empty($reshook)) {
	$demoprofiles = array(
		...
		//'icon'=>DOL_URL_ROOT.'/public/demo/powererp_screenshot8.png',
		...
		//'icon'=>DOL_URL_ROOT.'/public/demo/powererp_screenshot2.png',
		...
		//'icon'=>DOL_URL_ROOT.'/public/demo/powererp_screenshot6.png',
		...
		//'icon'=>DOL_URL_ROOT.'/public/demo/powererp_screenshot9.png'
...
llxHeaderVierge($langs->trans("PowerERPDemo"), $head);
