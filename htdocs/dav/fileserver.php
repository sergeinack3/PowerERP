...
$authBackend = new \Sabre\DAV\Auth\Backend\BasicCallBack(function ($username, $password) {
	...
	if ($powererp_main_authentication == 'forceuser') {
		...
		if ($powererp_auto_user != $username) {
			dol_syslog("Warning: your instance is set to use the automatic forced login '".$powererp_auto_user."' that is not the requested login. DAV usage is forbidden in this mode.");
			return false;
		}
	}
