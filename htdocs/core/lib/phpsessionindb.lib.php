...
function dolSessionOpen($save_path, $session_name)
{
	...
	global $powererp_main_db_type, $powererp_main_db_host;
	global $powererp_main_db_user, $powererp_main_db_pass, $powererp_main_db_name, $powererp_main_db_port;

	global $powererp_session_db_type, $powererp_session_db_host;
	global $powererp_session_db_user, $powererp_session_db_pass, $powererp_session_db_name, $powererp_session_db_port;

	if (empty($powererp_session_db_type)) {	$powererp_session_db_type = $powererp_main_db_type; }
	if (empty($powererp_session_db_host)) {	$powererp_session_db_host = $powererp_main_db_host; }
	if (empty($powererp_session_db_user)) {	$powererp_session_db_user = $powererp_main_db_user; }
	if (empty($powererp_session_db_pass)) {	$powererp_session_db_pass = $powererp_main_db_pass; }
	if (empty($powererp_session_db_name)) {	$powererp_session_db_name = $powererp_main_db_name; }
	if (empty($powererp_session_db_port)) {	$powererp_session_db_port = $powererp_main_db_port; }
	//var_dump('open '.$database_name.' '.$table_name);

	$dbsession = getDoliDBInstance($powererp_session_db_type, $powererp_session_db_host, $powererp_session_db_user, $powererp_session_db_pass, $powererp_session_db_name, $powererp_session_db_port);
