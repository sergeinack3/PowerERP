...
class DolEditor
{
	 ...
	 *  @param 	string	$toolbarname	       		 	Name of bar set to use ('Full', 'powererp_notes[_encoded]', 'powererp_details[_encoded]'=the less featured, 'powererp_mailings[_encoded]', 'powererp_readonly').
