 ...
 */
class box_powererp_state_board extends ModeleBoxes
{
	public $boxcode = "powererpstatebox";
	public $boximg = "generic";
	public $boxlabel = "BoxPowererpStateBoard";
	...
	public function loadBox($max = 5)
	{
		...
		$this->max = $max;
		$this->info_box_head = array('text' => $langs->trans("PowererpStateBoard"));
