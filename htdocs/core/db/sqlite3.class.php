...
class DoliDBSqlite3 extends DoliDB
{
	 ...
	 *
	 *	@param	string	$powererp_main_db_host 		Ip serveur
	...
	public function DDLCreateUser($powererp_main_db_host, $powererp_main_db_user, $powererp_main_db_pass, $powererp_main_db_name)
	{
		...
		$sql .= " VALUES ('".$this->escape($powererp_main_db_host)."','".$this->escape($powererp_main_db_user)."',password('".addslashes($powererp_main_db_pass)."')";
		...
		$sql .= " VALUES ('".$this->escape($powererp_main_db_host)."','".$this->escape($powererp_main_db_name)."','".addslashes($powererp_main_db_user)."'";
		$sql .= ",'Y','Y','Y','Y','Y','Y','Y','Y','Y')";
