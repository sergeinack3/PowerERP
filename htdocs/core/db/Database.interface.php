...
interface Database
{
	 ...
	 *
	 * @param    string $powererp_main_db_host 	Server IP
	 * @param    string $powererp_main_db_user 	Username to create
	 * @param    string $powererp_main_db_pass 	User password to create
