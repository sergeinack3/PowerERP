...
class DoliDBPgsql extends DoliDB
{
	...
	public static function convertSQLFromMysql($line, $type = 'auto', $unescapeslashquot = false)
	{
		...
		if ($line != "") {
			...
			if ($type == 'dml') {
				...
				// ALTER TABLE llx_powererp_modules ADD PRIMARY KEY pk_powererp_modules (numero, entity)
				...
				// ALTER TABLE llx_powererp_modules DROP PRIMARY KEY pk_xxx
				...
				// ALTER TABLE llx_powererp_modules DROP FOREIGN KEY fk_xxx
	...
	public function encrypt($fieldorvalue, $withQuotes = 1)
	{
		...
		//$cryptType = ($conf->db->powererp_main_db_encryption ? $conf->db->powererp_main_db_encryption : 0);
	 ...
	 *
	 *	@param	string	$powererp_main_db_host 		Ip server
	 *	@param	string	$powererp_main_db_user 		Name of user to create
	 *	@param	string	$powererp_main_db_pass 		Password of user to create
	...
	public function DDLCreateUser($powererp_main_db_host, $powererp_main_db_user, $powererp_main_db_pass, $powererp_main_db_name)
	{
		...
		$sql = "CREATE USER ".$this->escape($powererp_main_db_user)." with password '".$this->escape($powererp_main_db_pass)."'";
