 ...
 */
class InterfaceActionsAuto extends PowerERPTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->version = self::VERSION_POWERERP;
		$this->picto = 'action';
	}
	...
	public function runTrigger($action, $object, User $user, Translate $langs, Conf $conf)
	{
		...
		if ($action == 'COMPANY_CREATE') {
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("NewCompanyToPowerERP", $object->name);
			}
			$object->actionmsg = $langs->transnoentities("NewCompanyToPowerERP", $object->name);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("COMPANY_MODIFYInPowerERP", $object->name);
			}
			$object->actionmsg = $langs->transnoentities("COMPANY_MODIFYInPowerERP", $object->name);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("CONTACT_CREATEInPowerERP", $object->getFullName($langs));
			}
			$object->actionmsg = $langs->transnoentities("CONTACT_CREATEInPowerERP", $object->getFullName($langs));
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("CONTACT_MODIFYInPowerERP", $object->name);
			}
			$object->actionmsg = $langs->transnoentities("CONTACT_MODIFYInPowerERP", $object->name);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("ContractValidatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			}
			$object->actionmsg = $langs->transnoentities("ContractValidatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("PropalValidatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			}
			$object->actionmsg = $langs->transnoentities("PropalValidatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			...
			if (empty($object->actionmsg2)) $object->actionmsg2 = $langs->transnoentities("PropalBackToDraftInPowerERP", ($object->newref ? $object->newref : $object->ref));
			$object->actionmsg = $langs->transnoentities("PropalBackToDraftInPowerERP", ($object->newref ? $object->newref : $object->ref));
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("PropalClosedSignedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("PropalClosedSignedInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("PropalClassifiedBilledInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("PropalClassifiedBilledInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("PropalClosedRefusedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("PropalClosedRefusedInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("OrderValidatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			}
			$object->actionmsg = $langs->transnoentities("OrderValidatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("OrderDeliveredInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("OrderDeliveredInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("OrderBilledInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("OrderBilledInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("OrderCanceledInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("OrderCanceledInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("InvoiceValidatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			}
			$object->actionmsg = $langs->transnoentities("InvoiceValidatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("InvoiceBackToDraftInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("InvoiceBackToDraftInPowerERP", $object->ref);
			...
			$object->actionmsg2 = $langs->transnoentities("InvoicePaidInPowerERP", $object->ref);
			$object->actionmsg = $langs->transnoentities("InvoicePaidInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("InvoiceCanceledInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("InvoiceCanceledInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("InterventionCreatedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("InterventionCreatedInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("InterventionValidatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			}
			$object->actionmsg = $langs->transnoentities("InterventionValidatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("InterventionModifiedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("InterventionModifiedInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("InterventionClassifiedBilledInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("InterventionClassifiedBilledInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("InterventionClassifiedUnbilledInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("InterventionClassifiedUnbilledInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("InterventionDeletedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("InterventionDeletedInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("OrderCreatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			}
			$object->actionmsg = $langs->transnoentities("OrderCreatedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("OrderApprovedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("OrderApprovedInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("OrderRefusedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("OrderRefusedInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("SupplierOrderSubmitedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			}
			$object->actionmsg = $langs->transnoentities("SupplierOrderSubmitedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("SupplierOrderReceivedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			}
			$object->actionmsg = $langs->transnoentities("SupplierOrderReceivedInPowerERP", ($object->newref ? $object->newref : $object->ref));
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("MemberValidatedInPowerERP", $object->getFullName($langs));
			}
			$object->actionmsg = $langs->transnoentities("MemberValidatedInPowerERP", $object->getFullName($langs));
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("MemberModifiedInPowerERP", $object->getFullName($langs));
			}
			$object->actionmsg = $langs->transnoentities("MemberModifiedInPowerERP", $object->getFullName($langs));
			$object->actionmsg .= "\n".$langs->transnoentities("Member").': '.$object->getFullName($langs);
			$object->actionmsg .= "\n".$langs->transnoentities("Type").': '.$object->type;
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("MemberSubscriptionAddedInPowerERP", $object->id, $member->getFullName($langs));
			}
			$object->actionmsg = $langs->transnoentities("MemberSubscriptionAddedInPowerERP", $object->id, $member->getFullName($langs));
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("MemberSubscriptionModifiedInPowerERP", $object->id, $member->getFullName($langs));
			}
			$object->actionmsg = $langs->transnoentities("MemberSubscriptionModifiedInPowerERP", $object->id, $member->getFullName($langs));
			$object->actionmsg .= "\n".$langs->transnoentities("Member").': '.$member->getFullName($langs);
			$object->actionmsg .= "\n".$langs->transnoentities("Type").': '.$object->fk_type;
			$object->actionmsg .= "\n".$langs->transnoentities("Amount").': '.$object->amount;
			$object->actionmsg .= "\n".$langs->transnoentities("Period").': '.dol_print_date($object->dateh, 'day').' - '.dol_print_date($object->datef, 'day');
			...
			$object->actionmsg = $langs->transnoentities("MemberSubscriptionDeletedInPowerERP", $object->ref, $member->getFullName($langs));
			$object->actionmsg .= "\n".$langs->transnoentities("Member").': '.$member->getFullName($langs);
			$object->actionmsg .= "\n".$langs->transnoentities("Type").': '.$object->fk_type;
			$object->actionmsg .= "\n".$langs->transnoentities("Amount").': '.$object->amount;
			$object->actionmsg .= "\n".$langs->transnoentities("Period").': '.dol_print_date($object->dateh, 'day').' - '.dol_print_date($object->datef, 'day');
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("MemberSubscriptionDeletedInPowerERP", $object->ref, $member->getFullName($langs));
			}
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("MemberResiliatedInPowerERP", $object->getFullName($langs));
			}
			$object->actionmsg = $langs->transnoentities("MemberResiliatedInPowerERP", $object->getFullName($langs));
			$object->actionmsg .= "\n".$langs->transnoentities("Member").': '.$object->getFullName($langs);
			$object->actionmsg .= "\n".$langs->transnoentities("Type").': '.$object->type;
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("MemberDeletedInPowerERP", $object->getFullName($langs));
			}
			$object->actionmsg = $langs->transnoentities("MemberDeletedInPowerERP", $object->getFullName($langs));
			$object->actionmsg .= "\n".$langs->transnoentities("Member").': '.$object->getFullName($langs);
			$object->actionmsg .= "\n".$langs->transnoentities("Type").': '.$object->type;
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("MemberExcludedInPowerERP", $object->getFullName($langs));
			}
			$object->actionmsg = $langs->transnoentities("MemberExcludedInPowerERP", $object->getFullName($langs));
			$object->actionmsg .= "\n".$langs->transnoentities("Member").': '.$object->getFullName($langs);
			$object->actionmsg .= "\n".$langs->transnoentities("Type").': '.$object->type;
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("ProjectCreatedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("ProjectCreatedInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("ProjectValidatedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("ProjectValidatedInPowerERP", $object->ref);
			$object->actionmsg .= "\n".$langs->transnoentities("Project").': '.$object->ref;
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("ProjectModifiedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("ProjectModifiedInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("TaskCreatedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("TaskCreatedInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("TaskModifiedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("TaskModifieddInPowerERP", $object->ref);
			$object->actionmsg .= "\n".$langs->transnoentities("Task").': '.$object->ref;
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("TaskDeletedInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("TaskDeletedInPowerERP", $object->ref);
			$object->actionmsg .= "\n".$langs->transnoentities("Task").': '.$object->ref;
			...
			if (empty($object->actionmsg2)) {
				$object->actionmsg2 = $langs->transnoentities("TICKET_ASSIGNEDInPowerERP", $object->ref);
			}
			$object->actionmsg = $langs->transnoentities("TICKET_ASSIGNEDInPowerERP", $object->ref);
			...
			if (empty($object->actionmsg2)) {
				...
				if ($langs->transnoentities($action."InPowerERP", (empty($object->newref) ? $object->ref : $object->newref)) != $action."InPowerERP") {	// specific translation key
					$object->actionmsg2 = $langs->transnoentities($action."InPowerERP", (empty($object->newref) ? $object->ref : $object->newref));
				} else {	// generic translation key
					$tmp = explode('_', $action);
					$object->actionmsg2 = $langs->transnoentities($tmp[count($tmp) - 1]."InPowerERP", (empty($object->newref) ? $object->ref : $object->newref));
				}
			}
			if (empty($object->actionmsg)) {
				$langs->loadLangs(array("agenda", "other"));
				if ($langs->transnoentities($action."InPowerERP", (empty($object->newref) ? $object->ref : $object->newref)) != $action."InPowerERP") {	// specific translation key
					$object->actionmsg = $langs->transnoentities($action."InPowerERP", (empty($object->newref) ? $object->ref : $object->newref));
				} else {	// generic translation key
					$tmp = explode('_', $action);
					$object->actionmsg = $langs->transnoentities($tmp[count($tmp) - 1]."InPowerERP", (empty($object->newref) ? $object->ref : $object->newref));
				}
			}
