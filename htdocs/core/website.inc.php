...
if ($pageid > 0) {
	...
	if (!defined('USEPOWERERPEDITOR') && (in_array($websitepage->type_container, array('menu', 'other')) || empty($websitepage->status) && !defined('USEPOWERERPSERVER'))) {
...
if (!defined('USEPOWERERPEDITOR') && empty($website->status)) {
	// Security options
