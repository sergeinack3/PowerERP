...
{
	public $name = 'PowerERPContractsLinesExpired';
	...
	public function __construct($db)
	{
		...
		if ($result) {
			...
			dol_syslog("powererp_services_expired.modules.php:mailing_powererp_services_expired ".$num." services found");
	...
	public function getNbOfRecipients($sql = '')
	{
		...
		// Example: return parent::getNbOfRecipients("SELECT count(*) as nb from powererp_table");
		// Example: return 500;
