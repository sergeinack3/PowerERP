 ...
 */
class modUser extends PowerERPModules
{
	...
	public function __construct($db)
	{
		...
		$this->requiredby = array('modAdherent'); // List of module ids to disable if this one is disabled
		...
		$this->boxes = array(
			...
			2=>array('file'=>'box_powererp_state_board.php', 'enabledbydefaulton'=>'Home')
		);
