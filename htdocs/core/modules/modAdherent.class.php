 ...
 */
class modAdherent extends PowerERPModules
{
	...
	public function __construct($db)
	{
		...
		$this->depends = array(
			'Holiday' => 'modHoliday',
			'Recrutement' => 'modRecruitment',
			'Notes de frais' => 'modExpenseReport',
			'GRH' => 'modHRM',
			'E-CV' => 'modecv',
			'Pw-Recrutement' => 'modrecrutement',
			'SalariesContracts' => 'modSalariesContracts',
			'Tiers' => 'modSociete',
			'Propositions commerciales' => 'modPropale',
			'Commandes' => 'modCommande',
			'Expéditions' => 'modExpedition',
			'Contrats/Abonnements' => 'modContrat',
			'Interventions' => 'modFicheinter',
			'Ticket' => 'modTicket',
			'process' => 'modProcess',
			'CRM avancé' => 'modcrmenhanced',
			'Gestion d\'une base de connaissance' => 'modKnowledgeManagement',
			'Fournisseurs' => 'modFournisseur',
			'Propositions commerciales fournisseurs' => 'modSupplierProposal',
			'Réception' => 'modReception',
			'Incoterms' => 'modIncoterm',
			'Factures et avoirs' => 'modFacture',
			'Taxes et dépenses spéciales' => 'modTax',
			'Salaires' => 'modSalaries',
			'Emprunts' => 'modLoan',
			'Dons' => 'modDon',
			'Banques et caisses' => 'modBanque',
			'Paiement par virement bancaire' => 'modPaymentByBankTransfer',
			'Règlement par Prélèvement' => 'modPrelevement',
			'Marges' => 'modMargin',
			'Comptabilité (simplifié)' => 'modComptabilite',
			'Comptabilité (partie double)' => 'modAccounting',
			'Emprunt' => 'modEmprunt',
			'Paie' => 'modpayrollmod',
			'Produits' => 'modProduct',
			'Services' => 'modService',
			'Stock' => 'modStock',
			'Numéros de Lot/Série' => 'modProductBatch',
			'Variantes de produits' => 'modVariants',
			'Nomenclatures produits (BOM)' => 'modBom',
			'Ordres de fabrication' => 'modMrp',
			'CoefPricR' => 'modcoefpricr',
			'factory' => 'modfactory',
			'restock' => 'modRestock',
			'Gerec' => 'modGerec',
			'Verifystock' => 'modVerifystock',
			'Projets ou Opportunités' => 'modProjet',
			'Événements/Agenda' => 'modAgenda',
			'Ressources' => 'modResource',
			'ProjectBudget' => 'modprojectbudget',
			'Feuille de temps' => 'modTimesheet',
			'GED' => 'modECM',
			'Libellés/Catégories' => 'modCategorie',
			'Éditeur WYSIWYG' => 'modFckeditor',
			'Multi-devise' => 'modMultiCurrency',
			'Flux RSS' => 'modExternalRss',
			'Marque-pages et raccourci' => 'modBookmark',
			'Codes-barres' => 'modBarcode',
			'Workflow Inter-modules' => 'modWorkflow',
			'Imports de données' => 'modImport',
			'Exports de données' => 'modExport',
			'Concat PDF' => 'modConcatPdf',
			'kanprospects' => 'modKanprospects',
			'Générateur de Module et Application' => 'modModuleBuilder',
			'Sondage ou Vote' => 'modOpenSurvey',
			'Sites web' => 'modWebsite',
			'PdV TakePOS' => 'modTakePos',
			'Réseaux sociaux' => 'modSocialNetworks',
			'Notifications sur les évênements métiers' => 'modNotification',
			'Emailing' => 'modMailing',
			'Collecteur de courrier électronique' => 'modEmailCollector',
			'Collecteur de courrier électronique' => 'modEmailCollector',
			'API/Web services (serveur REST)' => 'modApi',
			'API/Web services (serveur SOAP)' => 'modWebServices',
			'LDAP' => 'modLdap',
			'Oauth' => 'modOauth',
			'Site externe' => 'modExternalSite',
			'FTP' => 'modFTP',
			'GeoIPMaxmind' => 'modGeoIPMaxmind',
			'PayBox' => 'modPayBox',
			'Paypal' => 'modPaypal',
			'Stripe' => 'modStripe',
			'ClickToDial' => 'modClickToDial',
			'Printing' => 'modPrinting',
			'Imprimantes Tickets' => 'modReceiptPrinter',
			'Mailman and SPIP' => 'modMailmanSpip',
			'Gravatar' => 'modGravatar',
			'Dav' => 'modDav',
			'Travaux planifiés' => 'modCron',
			'Journaux et traces de Debug' => 'modSyslog',
			'Barre de débogage' => 'modDebugBar',
			'Archives/Logs Inaltérables' => 'modBlockedLog',
			'ExtraPrice' => 'modExtraPrice',
			'Gestion des pannes' => 'modgestionpannes',
			'Approbations' => 'modapprobation',
			'E-CV' => 'modecv',
			'Gantt avancée' => 'modtaskgantt',
			'NumberWords' => 'modNumberWords',
			'myDoliboard' => 'modmydoliboard',
			'myField' => 'modmyfield',
			'ultimatepdf' => 'modultimatepdf',
			'Chat' => 'modChat',
