 ...
 */
class modStockTransfer extends PowerERPModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 701; // TODO Go on page https://wiki.powererp.org/index.php/List_of_modules_id to reserve an id number for your module
