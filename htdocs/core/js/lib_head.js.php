	...
	$.widget( "ui.combobox", {
		...
		_create: function() {
			...
			var input = this.input = $( "<input>" )
				...
				.addClass( "ui-widget ui-widget-content ui-corner-left powererpcombobox" );
 ...
 * @param  {string} force_locale     ISO code locale to use (if empty, will use PowerERP's current locale code)
...
function pricejs(amount, mode = 'MT', currency_code = '', force_locale = '') {
	...
	// No Intl -> attempt to format the number in a way similar to PowerERP PHP's `price()` function
