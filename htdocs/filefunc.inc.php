...
if (!defined('NOCSRFCHECK') && isset($powererp_nocsrfcheck) && $powererp_nocsrfcheck == 1) {    // If $powererp_nocsrfcheck is 0, there is a strict CSRF test with token in main
