 ...
 */
class Shipments extends PowererpApi
{
	...
	public function get($id)
	{
		...
		if (!PowererpApi::_checkAccessToResource('expedition', $this->shipment->id)) {
	...
	public function post($request_data = null)
	{
		...
		if ($this->shipment->create(PowererpApiAccess::$user) < 0) {
	...
	*/
	...
	public function deleteLine($id, $lineid)
	{
		...
		$updateRes = $this->shipment->deleteline(PowererpApiAccess::$user, $lineid);
		if ($updateRes > 0) {
			return $this->get($id);
		} else {
	...
	public function put($id, $request_data = null)
	{
		...
		if ($this->shipment->update(PowererpApiAccess::$user) > 0) {
			return $this->get($id);
		} else {
	...
	{
		if (!PowererpApiAccess::$user->rights->expedition->supprimer) {
			throw new RestException(401);
		}
		$result = $this->shipment->fetch($id);
		if (!$result) {
		...
		if (!$this->shipment->delete(PowererpApiAccess::$user)) {
	...
	public function validate($id, $notrigger = 0)
	{
		...
		$result = $this->shipment->valid(PowererpApiAccess::$user, $notrigger);
		if ($result == 0) {
	...
	public function setinvoiced($id)
	{
		...
		$result = $this->shipment->classifyBilled(PowererpApiAccess::$user);
		if( $result < 0) {
	...
	*/
	...
	public function createShipmentFromOrder($orderid)
	{
		...
		$result = $this->shipment->createFromOrder($order, PowererpApiAccess::$user);
		if( $result < 0) {
				throw new RestException(405, $this->shipment->error);
		}
		$this->shipment->fetchObjectLinked();
	...
	*/
	public function close($id, $notrigger = 0)
	{
		...
		if (!PowererpApi::_checkAccessToResource('expedition', $this->commande->id)) {
			throw new RestException(401, 'Access not allowed for login '.PowererpApiAccess::$user->login);
		}
