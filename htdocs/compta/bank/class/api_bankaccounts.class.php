 ...
 */
class BankAccounts extends PowererpApi
{
	/**
	...
	public function index($sortfield = "t.rowid", $sortorder = 'ASC', $limit = 100, $page = 0, $category = 0, $sqlfilters = '')
	{
		...
		if (!PowererpApiAccess::$user->rights->banque->lire) {
	...
	{
		if (!PowererpApiAccess::$user->rights->banque->configurer) {
			throw new RestException(401);
		}
	...
	{
		if (!PowererpApiAccess::$user->rights->banque->modifier) {
			throw new RestException(401);
		}
