...
class Website extends CommonObject
{
	...
	public function createFromClone($user, $fromid, $newref, $newlang = '')
	{
		...
		$pathofwebsiteold = $powererp_main_data_root.'/website/'.dol_sanitizeFileName($oldref);
		$pathofwebsitenew = $powererp_main_data_root.'/website/'.dol_sanitizeFileName($newref);
