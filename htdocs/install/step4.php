...
if ($db->ok) {
	...
	print '<input id="login" name="login" type="text" value="'.(!empty($_GET["login"]) ? GETPOST("login", 'alpha') : (isset($force_install_powererplogin) ? $force_install_powererplogin : '')).'"'.(@$force_install_noedit == 2 && $force_install_powererplogin !== null ? ' disabled' : '').'></td></tr>';
