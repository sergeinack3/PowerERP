...
powererp_install_syslog("- step4: entering step4.php page");
...
print '<h3><img class="valignmiddle inline-block paddingright" src="../theme/common/octicons/build/svg/key.svg" width="20" alt="Database"> '.$langs->trans("PowerERPAdminLogin").'</h3>';
...
if ($db->ok) {
	...
	print '<input id="login" name="login" type="text" value="'.(GETPOSTISSET("login") ? GETPOST("login", 'alpha') : (isset($force_install_powererplogin) ? $force_install_powererplogin : '')).'"'.(@$force_install_noedit == 2 && $force_install_powererplogin !== null ? ' disabled' : '').' autofocus></td></tr>';
...
powererp_install_syslog("- step4: end");
