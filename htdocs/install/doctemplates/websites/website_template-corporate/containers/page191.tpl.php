...
<meta name="powererp:pageid" content="191" />
...
<div class="row justify-content-sm-center row-40">
    <div class="col-sm-8 col-md-2 col-lg-2">
        <div>
            <img src="/viewimage.php?modulepart=medias&file=image/template-corporate/powererp_256x256.png" height="64px"><br>
            <div class="floatatbottom"><a href="https://www.powererp.org" target="_new">PowerERP ERP CRM</a></div>
        </div>
    </div>
