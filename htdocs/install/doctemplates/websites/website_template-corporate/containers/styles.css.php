...
if (! defined('USEPOWERERPSERVER') && ! defined('USEPOWERERPEDITOR')) { require_once __DIR__.'/master.inc.php'; } // Load env if not already loaded
...
.bodywebsite section#sectionfooterpowererp {
  padding-left: 3px;
  padding-right: 3px;
  padding-bottom: 10px;
}
