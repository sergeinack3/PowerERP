...
if (empty($powererp_main_url_root)) {
	$powererp_main_document_root = detect_powererp_main_document_root();
}
?>
		<td class="label">
			<input type="text"
...
?>
	...
	<tr>
		...
		if (empty($powererp_main_data_root)) {
			$powererp_main_data_root = detect_powererp_main_data_root($powererp_main_document_root);
		}
		?>
		<td class="label">
			<input type="text"
...
<?php if (!empty($force_install_noedit)) {
	...
	<?php
	if (empty($powererp_main_url_root)) {
		$powererp_main_url_root = detect_powererp_main_url_root();
	}
	?>
	<tr>
...
?>
	...
	<tr>
		...
		$defaultype = !empty($powererp_main_db_type) ? $powererp_main_db_type : ($force_install_type ? $force_install_type : 'mysqli');
