...
-- Cameroun Provinces (id country=24)
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24010, '01','Tibati',0,'DJEREM','Djérem');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24010, '02','Tignère',0,'FARO-ET-DEO','Faro-et-Déo');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24010, '03','Banyo',0,'MAYO-BANYO','Mayo-Banyo');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24010, '04','Meiganga',0,'MBERE','Mbéré');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24010, '05','Ngaoundéré',0,'VINA','Vina');

insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24020, '06','Nanga-Eboko',0,'HAUTE-SANAGA','Haute-Sanaga');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24020, '07','Monatele',0,'LEKIE','Lekié');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24020, '08','Bafia',0,'MBAM-ET-INOUBOU','Mbam-et-Inoubou');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24020, '09','Ntui',0,'MBAM-ET-KIM','Mbam-et-Kim');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24020, '10','Mfou',0,'MEFOU-ET-AFAMBA','Méfou-et-Afamba');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24020, '11','Ngoumou',0,'MEFOU-ET-AKONO','Méfou-et-Akono');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24020, '12','Yaoundé',0,'MFOUNDI','Mfoundi');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24020, '13','Éséka',0,'NYONG-ET-KELLE','Nyong-et-Kellé');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24020, '14','Akonolinga',0,'NYONG-ET-MFOUMOU','Nyong-et-Mfoumou');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24020, '15','Mbalmayo',0,'NYONG-ET-SO’O','Nyong-et-So’o');

insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24030, '16','Yokadouma',0,'BOUMBA-ET-NGOKO','Boumba-et-Ngoko');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24030, '17','Abong-Mbang',0,'HAUT-NYONG','Haut-Nyong');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24030, '18','Batouri',0,'KADEY','Kadey');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24030, '19','Bertoua',0,'LOM-ET-DJEREM','Lom-et-Djérem');

insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24040, '20','Maroua',0,'DIAMARE','Diamaré');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24040, '21','Kousséri',0,'LOGONE-ET-CHARI','Logone-et-Chari');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24040, '22','Yagoua',0,'MAYO-DANAY','Mayo-Danay');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24040, '23','Kaélé',0, 'MAYO-KANI','Mayo-Kani');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24040, '24','Mora',0,'MAYO-SAVA','Mayo-Sava');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24040, '25','Mokolo',0,'MAYO-TSANAGA','Mayo-Tsanaga');

insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24050, '26','Nkongsamba',0,'MOUNGO','Moungo');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24050, '27','Yabassi',0,'NKAM','Nkam');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24050, '28','Édéa',0,'SANAGA-MARITIME','Sanaga-Maritime');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24050, '29','Douala',0,'WOURI','Wouri');

insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24060, '30','Garoua',0,'BENOUE','Bénoué');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24060, '31','Poli',0,'FARO','Faro');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24060, '32','Guider',0,'MAYO-LOUTI','Mayo-louti');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24060, '33','Tcholliré',0,'MAYO-REY','Mayo-rey');

insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24070, '34','Fundong',0,'BOYO','Boyo');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24070, '35','Kumbo',0,'BUI','Bui');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24070, '36','Nkambé',0,'DONGA-MANTUNG','Donga-Mantung');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24070, '37','Wum',0,'MENCHUM','Menchum');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24070, '38','Bamenda',0,'MEZAM','Mezam');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24070, '39','Mbengwi',0,'MOMO','Momo');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24070, '40','Ndop',0,'NGO-KETUNJIA','Ngo-Ketunjia');

insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24080, '41','Mbouda',0,'BAMBOUTOS','Bamboutos');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24080, '42','Bafang',0,'HAUT-NKAM','Haut-Nkam');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24080, '43','baham',0,'HAUTS-PLATEAUX','Hauts-Plateaux');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24080, '44','Bandjoun',0,'KOUNG-KHI','Koung-Khi');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24080, '45','Bafoussam',0,'MENOUA','Menoua');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24080, '46','Bangangté',0,'MIFI','Mifi');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24080, '47','Foumban',0,'NDE','Ndé');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24080, '48','Foumban',0,'NOUN','Noun');

insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24090, '49','Sangmélima',0,'DJA-ET-LOBO','Dja-et-Lobo');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24090, '50','Ebolowa',0,'MVILA','Mvila');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24090, '51','Kribi',0,'OCEAN','Océan');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24090, '52','Ambam',0,'VALLEE-DU-NTEM','Vallée-du-Ntem');

insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24100, '53','Limbé',0,'FAKO','fako');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24100, '54','Bangem',0,'KOUPE-MANENGOUBA','Koupé-Manengouba');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24100, '55','Menji',0,'LEBIALEM','Lebialem');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24100, '56','Mamfé',0,'MANYU','Manyu');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24100, '57','Kumba',0,'MEME','Meme');
insert into llx_c_departements (fk_region, code_departement, cheflieu, tncc, ncc, nom) values (24100, '58', 'Mundemba',0,'NDIAN','Ndian');