...
-- VMYSQL4.1 INSERT INTO llx_boxes_def (file, entity) SELECT  'box_powererp_state_board.php', 1 FROM DUAL WHERE NOT EXISTS (SELECT * FROM llx_boxes_def WHERE file = 'box_powererp_state_board.php' AND entity = 1);
