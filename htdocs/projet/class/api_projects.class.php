 ...
 */
class Projects extends PowererpApi
{
	...
	public function post($request_data = null)
	{
		...
		if ($this->project->create(PowererpApiAccess::$user) < 0) {
	...
	*/
	...
	public function put($id, $request_data = null)
	{
		...
		if ($this->project->update(PowererpApiAccess::$user) >= 0) {
			return $this->get($id);
		} else {
	...
	public function delete($id)
	{
		...
		if (!$this->project->delete(PowererpApiAccess::$user)) {
	...
	public function validate($id, $notrigger = 0)
	{
		...
		$result = $this->project->setValid(PowererpApiAccess::$user, $notrigger);
		if ($result == 0) {
