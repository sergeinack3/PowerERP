...
$doleditor = new DolEditor('ONLINE_PAYMENT_MESSAGE_FORM', $conf->global->ONLINE_PAYMENT_MESSAGE_FORM, '', 100, 'powererp_details', 'In', false, true, true, ROWS_4, '90%');
$doleditor->Create();
print '</td></tr>';
...
$doleditor = new DolEditor('ONLINE_PAYMENT_MESSAGE_OK', $conf->global->ONLINE_PAYMENT_MESSAGE_OK, '', 100, 'powererp_details', 'In', false, true, true, ROWS_4, '90%');
$doleditor->Create();
print '</td></tr>';
...
$doleditor = new DolEditor('ONLINE_PAYMENT_MESSAGE_KO', $conf->global->ONLINE_PAYMENT_MESSAGE_KO, '', 100, 'powererp_details', 'In', false, true, true, ROWS_4, '90%');
$doleditor->Create();
print '</td></tr>';
