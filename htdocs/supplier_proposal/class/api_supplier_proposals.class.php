 ...
 */
class Supplierproposals extends PowerERPApi
{
	...
	{
		if (!PowerERPApiAccess::$user->rights->supplier_proposal->lire) {
		...
		if (!PowerERPApi::_checkAccessToResource('supplier_proposal', $this->propal->id)) {
